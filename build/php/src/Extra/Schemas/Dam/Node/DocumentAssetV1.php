...
namespace Extra\Schemas\Dam\Node;
...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:document-asset:v1';
    const MIXINS = [
