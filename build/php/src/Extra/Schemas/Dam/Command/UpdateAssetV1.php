...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:update-asset:v1';
    const MIXINS = [
