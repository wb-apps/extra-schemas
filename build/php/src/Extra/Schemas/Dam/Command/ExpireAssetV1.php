...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:expire-asset:v1';
    const MIXINS = [
