...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:link-assets:v1';
    const MIXINS = [
