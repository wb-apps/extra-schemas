...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:get-asset-request:v1';
    const MIXINS = [
