...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:get-upload-urls-response:v1';
    const MIXINS = [
