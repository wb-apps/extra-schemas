...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:get-asset-history-request:v1';
    const MIXINS = [
