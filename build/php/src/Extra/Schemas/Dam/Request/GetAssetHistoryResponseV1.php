...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:get-asset-history-response:v1';
    const MIXINS = [
