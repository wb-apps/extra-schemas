...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-updated:v1';
    const MIXINS = [
