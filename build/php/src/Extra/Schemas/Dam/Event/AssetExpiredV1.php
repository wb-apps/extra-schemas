...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-expired:v1';
    const MIXINS = [
