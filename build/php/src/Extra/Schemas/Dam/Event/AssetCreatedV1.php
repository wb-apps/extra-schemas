...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-created:v1';
    const MIXINS = [
