...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-deleted:v1';
    const MIXINS = [
