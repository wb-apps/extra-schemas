...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-linked:v1';
    const MIXINS = [
