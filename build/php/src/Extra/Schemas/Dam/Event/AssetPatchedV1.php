...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-patched:v1';
    const MIXINS = [
