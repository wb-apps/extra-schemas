...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-unpublished:v1';
    const MIXINS = [
