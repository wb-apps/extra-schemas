...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-published:v1';
    const MIXINS = [
