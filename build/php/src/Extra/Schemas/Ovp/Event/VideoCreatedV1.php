...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-created:v1';
    const MIXINS = [
