...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-marked-as-draft:v1';
    const MIXINS = [
