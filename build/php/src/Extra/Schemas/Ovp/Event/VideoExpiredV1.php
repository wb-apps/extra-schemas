...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-expired:v1';
    const MIXINS = [
