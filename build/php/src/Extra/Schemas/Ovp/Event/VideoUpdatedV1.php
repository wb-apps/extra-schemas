...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-updated:v1';
    const MIXINS = [
