...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-deleted:v1';
    const MIXINS = [
