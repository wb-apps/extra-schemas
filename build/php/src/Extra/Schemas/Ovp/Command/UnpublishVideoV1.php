...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:unpublish-video:v1';
    const MIXINS = [
