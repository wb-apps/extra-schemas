...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:update-video:v1';
    const MIXINS = [
