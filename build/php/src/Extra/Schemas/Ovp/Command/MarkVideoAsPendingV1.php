...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [
