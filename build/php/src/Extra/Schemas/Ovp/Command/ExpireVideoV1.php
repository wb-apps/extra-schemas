...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:expire-video:v1';
    const MIXINS = [
