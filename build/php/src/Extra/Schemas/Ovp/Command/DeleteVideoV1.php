...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:delete-video:v1';
    const MIXINS = [
