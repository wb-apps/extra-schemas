...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:search-videos-request:v1';
    const MIXINS = [
