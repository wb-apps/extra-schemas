...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:get-category-request:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:get-category-request';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:get-category-request:v1';
    const MIXINS = [
