...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:get-channel-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:get-channel-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:get-channel-history-request:v1';
    const MIXINS = [
