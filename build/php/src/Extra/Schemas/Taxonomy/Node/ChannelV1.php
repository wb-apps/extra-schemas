...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:node:channel:v1';
    const MIXINS = [
