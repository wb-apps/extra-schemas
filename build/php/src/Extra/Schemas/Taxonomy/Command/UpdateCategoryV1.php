...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:update-category:v1';
    const MIXINS = [
