...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:update-channel:v1';
    const MIXINS = [
