...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:create-category:v1';
    const MIXINS = [
