...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:category-updated:v1';
    const MIXINS = [
