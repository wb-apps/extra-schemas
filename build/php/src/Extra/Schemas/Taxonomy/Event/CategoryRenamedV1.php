...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:category-renamed:v1';
    const MIXINS = [
