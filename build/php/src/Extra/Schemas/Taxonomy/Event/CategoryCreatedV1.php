...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:category-created:v1';
    const MIXINS = [
