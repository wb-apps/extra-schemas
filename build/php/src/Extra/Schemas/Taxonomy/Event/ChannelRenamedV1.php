...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:channel-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:channel-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:channel-renamed:v1';
    const MIXINS = [
