...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:channel-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:channel-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:channel-deleted:v1';
    const MIXINS = [
