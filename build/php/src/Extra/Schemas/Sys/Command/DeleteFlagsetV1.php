...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:delete-flagset:v1';
    const MIXINS = [
