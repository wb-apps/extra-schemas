...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:create-flagset:v1';
    const MIXINS = [
