...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:delete-picklist:v1';
    const MIXINS = [
