...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-flagset-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-flagset-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-flagset-history-request:v1';
    const MIXINS = [
