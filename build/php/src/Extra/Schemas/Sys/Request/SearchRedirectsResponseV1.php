...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:search-redirects-response:v1';
    const MIXINS = [
