...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:list-all-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:list-all-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:list-all-flagsets-request:v1';
    const MIXINS = [
