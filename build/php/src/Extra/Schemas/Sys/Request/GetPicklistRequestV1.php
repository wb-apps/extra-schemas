...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-picklist-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-picklist-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-picklist-request:v1';
    const MIXINS = [
