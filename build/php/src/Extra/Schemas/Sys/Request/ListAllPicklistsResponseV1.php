...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:list-all-picklists-response:v1';
    const MIXINS = [
