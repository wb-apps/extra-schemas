...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-redirect-request:v1';
    const MIXINS = [
