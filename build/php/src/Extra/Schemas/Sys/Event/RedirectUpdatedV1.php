...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:redirect-updated:v1';
    const MIXINS = [
