...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:flagset-created:v1';
    const MIXINS = [
