...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:flagset-updated:v1';
    const MIXINS = [
