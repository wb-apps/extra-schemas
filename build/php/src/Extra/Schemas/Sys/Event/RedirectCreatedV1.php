...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:redirect-created:v1';
    const MIXINS = [
