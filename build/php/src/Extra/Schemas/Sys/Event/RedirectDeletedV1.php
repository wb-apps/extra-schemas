...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:redirect-deleted:v1';
    const MIXINS = [
