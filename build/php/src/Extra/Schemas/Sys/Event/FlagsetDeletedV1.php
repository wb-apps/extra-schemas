...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:flagset-deleted:v1';
    const MIXINS = [
