...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:picklist-deleted:v1';
    const MIXINS = [
