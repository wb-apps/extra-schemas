...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:picklist-updated:v1';
    const MIXINS = [
