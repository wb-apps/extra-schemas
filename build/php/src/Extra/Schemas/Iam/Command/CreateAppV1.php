...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:create-app:v1';
    const MIXINS = [
