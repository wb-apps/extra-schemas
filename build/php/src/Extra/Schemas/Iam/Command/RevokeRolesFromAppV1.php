...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:revoke-roles-from-app:v1';
    const MIXINS = [
