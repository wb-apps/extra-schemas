...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:revoke-roles-from-user:v1';
    const MIXINS = [
