...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:update-role:v1';
    const MIXINS = [
