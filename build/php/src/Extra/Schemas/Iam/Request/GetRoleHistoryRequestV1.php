...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:get-role-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:get-role-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:get-role-history-request:v1';
    const MIXINS = [
