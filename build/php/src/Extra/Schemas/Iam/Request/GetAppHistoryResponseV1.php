...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:get-app-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:get-app-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:get-app-history-response:v1';
    const MIXINS = [
