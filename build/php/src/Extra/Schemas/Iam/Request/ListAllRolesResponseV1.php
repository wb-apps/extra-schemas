...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:list-all-roles-response:v1';
    const MIXINS = [
