...
{
    const SCHEMA_ID = 'pbj:extra:iam:node:android-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:node:android-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:node:android-app:v1';
    const MIXINS = [
