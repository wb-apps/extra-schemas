...
{
    const SCHEMA_ID = 'pbj:extra:iam:node:browser-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:node:browser-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:node:browser-app:v1';
    const MIXINS = [
