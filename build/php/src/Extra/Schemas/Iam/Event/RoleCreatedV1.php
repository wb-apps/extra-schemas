...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:role-created:v1';
    const MIXINS = [
