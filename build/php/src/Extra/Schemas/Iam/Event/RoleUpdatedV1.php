...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:role-updated:v1';
    const MIXINS = [
