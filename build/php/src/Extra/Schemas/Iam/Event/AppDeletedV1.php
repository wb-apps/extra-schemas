...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:app-deleted:v1';
    const MIXINS = [
