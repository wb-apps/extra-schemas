...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:role-deleted:v1';
    const MIXINS = [
