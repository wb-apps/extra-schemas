...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:app-roles-revoked:v1';
    const MIXINS = [
