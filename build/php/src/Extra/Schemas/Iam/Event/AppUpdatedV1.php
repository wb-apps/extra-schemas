...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:app-updated:v1';
    const MIXINS = [
