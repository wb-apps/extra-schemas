...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:user-updated:v1';
    const MIXINS = [
