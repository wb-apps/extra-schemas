...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:create-promotion:v1';
    const MIXINS = [
