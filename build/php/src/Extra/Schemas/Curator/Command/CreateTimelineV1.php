...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:create-timeline:v1';
    const MIXINS = [
