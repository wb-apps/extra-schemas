...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:mark-teaser-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:mark-teaser-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:mark-teaser-as-draft:v1';
    const MIXINS = [
