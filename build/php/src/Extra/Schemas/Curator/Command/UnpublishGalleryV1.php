...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:unpublish-gallery:v1';
    const MIXINS = [
