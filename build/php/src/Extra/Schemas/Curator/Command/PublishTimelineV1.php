...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:publish-timeline:v1';
    const MIXINS = [
