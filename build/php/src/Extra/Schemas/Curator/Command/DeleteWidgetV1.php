...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:delete-widget:v1';
    const MIXINS = [
