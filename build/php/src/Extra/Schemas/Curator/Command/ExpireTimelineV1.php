...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:expire-timeline:v1';
    const MIXINS = [
