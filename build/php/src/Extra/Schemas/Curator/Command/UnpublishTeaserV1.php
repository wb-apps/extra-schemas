...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:unpublish-teaser:v1';
    const MIXINS = [
