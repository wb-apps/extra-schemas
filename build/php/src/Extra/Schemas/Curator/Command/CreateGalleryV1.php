...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:create-gallery:v1';
    const MIXINS = [
