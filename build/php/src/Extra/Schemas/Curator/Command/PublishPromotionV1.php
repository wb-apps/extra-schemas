...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:publish-promotion:v1';
    const MIXINS = [
