...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:sync-teaser:v1';
    const MIXINS = [
