...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-gallery:v1';
    const MIXINS = [
