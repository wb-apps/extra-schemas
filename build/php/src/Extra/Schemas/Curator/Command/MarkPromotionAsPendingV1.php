...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:mark-promotion-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:mark-promotion-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:mark-promotion-as-pending:v1';
    const MIXINS = [
