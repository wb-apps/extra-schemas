...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-promotion:v1';
    const MIXINS = [
