...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:delete-promotion:v1';
    const MIXINS = [
