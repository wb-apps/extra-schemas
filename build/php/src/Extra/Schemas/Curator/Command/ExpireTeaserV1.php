...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:expire-teaser:v1';
    const MIXINS = [
