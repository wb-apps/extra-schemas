...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:delete-timeline:v1';
    const MIXINS = [
