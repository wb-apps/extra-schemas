...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-timeline:v1';
    const MIXINS = [
