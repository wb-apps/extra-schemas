...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-promotions-request:v1';
    const MIXINS = [
