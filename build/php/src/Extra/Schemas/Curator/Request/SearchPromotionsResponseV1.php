...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-promotions-response:v1';
    const MIXINS = [
