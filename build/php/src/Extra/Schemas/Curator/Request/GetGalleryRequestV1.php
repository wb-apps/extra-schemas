...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-gallery-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-gallery-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-gallery-request:v1';
    const MIXINS = [
