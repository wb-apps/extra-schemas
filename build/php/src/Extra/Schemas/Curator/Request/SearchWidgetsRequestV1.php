...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-widgets-request:v1';
    const MIXINS = [
