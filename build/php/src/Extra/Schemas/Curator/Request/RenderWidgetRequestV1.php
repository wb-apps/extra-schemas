...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:render-widget-request:v1';
    const MIXINS = [
