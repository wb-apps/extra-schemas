...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-widget-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-widget-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-widget-history-response:v1';
    const MIXINS = [
