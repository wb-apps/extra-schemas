...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-widget-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-widget-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-widget-request:v1';
    const MIXINS = [
