...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-timelines-response:v1';
    const MIXINS = [
