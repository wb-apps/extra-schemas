...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-teasers-request:v1';
    const MIXINS = [
