<?php
// @link https://schemas.extratv.com/json-schema/extra/curator/node/video-teaser/1-0-0.json#
    ...
    TrinitiTaxonomyHashtaggableV1
{
    ...
    {
        return new Schema('pbj:extra:curator:node:video-teaser:1-0-0', __CLASS__,
            [],
            [
