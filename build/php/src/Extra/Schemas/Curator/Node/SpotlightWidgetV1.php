...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:spotlight-widget:v1';
    const MIXINS = [
