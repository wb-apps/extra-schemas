...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:playlist-widget:v1';
    const MIXINS = [
