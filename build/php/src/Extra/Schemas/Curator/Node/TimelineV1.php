...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:timeline:v1';
    const MIXINS = [
