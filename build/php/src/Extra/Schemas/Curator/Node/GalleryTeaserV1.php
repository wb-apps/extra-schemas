...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:gallery-teaser:v1';
    const MIXINS = [
