...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:person-teaser:v1';
    const MIXINS = [
