...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:carousel-widget:v1';
    const MIXINS = [
