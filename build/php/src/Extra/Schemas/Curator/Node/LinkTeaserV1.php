...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:link-teaser:v1';
    const MIXINS = [
