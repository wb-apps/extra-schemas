...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:tetris-widget:v1';
    const MIXINS = [
