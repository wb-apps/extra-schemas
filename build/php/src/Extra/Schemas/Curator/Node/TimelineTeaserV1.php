...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:timeline-teaser:v1';
    const MIXINS = [
