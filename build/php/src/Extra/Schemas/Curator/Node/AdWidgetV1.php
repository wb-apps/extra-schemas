...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:ad-widget:v1';
    const MIXINS = [
