...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:poll-teaser:v1';
    const MIXINS = [
