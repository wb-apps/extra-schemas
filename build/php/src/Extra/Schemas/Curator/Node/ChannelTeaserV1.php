...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:channel-teaser:v1';
    const MIXINS = [
