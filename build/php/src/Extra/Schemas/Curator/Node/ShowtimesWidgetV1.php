...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:showtimes-widget:v1';
    const MIXINS = [
