...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:page-teaser:v1';
    const MIXINS = [
