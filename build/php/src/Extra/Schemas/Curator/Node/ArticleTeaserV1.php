...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:article-teaser:v1';
    const MIXINS = [
