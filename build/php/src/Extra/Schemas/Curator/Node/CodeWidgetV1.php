...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:code-widget:v1';
    const MIXINS = [
