...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:youtube-video-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:youtube-video-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:youtube-video-teaser:v1';
    const MIXINS = [
