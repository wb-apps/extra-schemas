...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:slider-widget:v1';
    const MIXINS = [
