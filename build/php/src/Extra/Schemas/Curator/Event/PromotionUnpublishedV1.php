...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-unpublished:v1';
    const MIXINS = [
