...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-deleted:v1';
    const MIXINS = [
