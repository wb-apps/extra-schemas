...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-updated:v1';
    const MIXINS = [
