...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-updated:v1';
    const MIXINS = [
