...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-marked-as-draft:v1';
    const MIXINS = [
