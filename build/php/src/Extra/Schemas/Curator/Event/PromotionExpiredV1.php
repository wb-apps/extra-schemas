...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-expired:v1';
    const MIXINS = [
