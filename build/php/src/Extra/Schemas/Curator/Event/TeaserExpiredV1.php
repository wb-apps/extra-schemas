...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-expired:v1';
    const MIXINS = [
