...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-expired:v1';
    const MIXINS = [
