...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-unpublished:v1';
    const MIXINS = [
