...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-published:v1';
    const MIXINS = [
