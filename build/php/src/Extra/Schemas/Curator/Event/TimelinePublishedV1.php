...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-published:v1';
    const MIXINS = [
