...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-renamed:v1';
    const MIXINS = [
