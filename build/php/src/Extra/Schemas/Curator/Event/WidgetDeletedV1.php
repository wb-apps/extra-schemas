...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:widget-deleted:v1';
    const MIXINS = [
