...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-image-count-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-image-count-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-image-count-updated:v1';
    const MIXINS = [
