...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:widget-created:v1';
    const MIXINS = [
