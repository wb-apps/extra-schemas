...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-deleted:v1';
    const MIXINS = [
