...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-scheduled:v1';
    const MIXINS = [
