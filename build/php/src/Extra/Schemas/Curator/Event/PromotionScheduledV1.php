...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-scheduled:v1';
    const MIXINS = [
