...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-expired:v1';
    const MIXINS = [
