...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-scheduled:v1';
    const MIXINS = [
