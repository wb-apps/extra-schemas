...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-published:v1';
    const MIXINS = [
