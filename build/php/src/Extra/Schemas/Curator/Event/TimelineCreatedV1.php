...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-created:v1';
    const MIXINS = [
