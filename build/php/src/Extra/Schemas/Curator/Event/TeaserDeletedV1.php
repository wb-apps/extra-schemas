...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-deleted:v1';
    const MIXINS = [
