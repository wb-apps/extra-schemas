...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-renamed:v1';
    const MIXINS = [
