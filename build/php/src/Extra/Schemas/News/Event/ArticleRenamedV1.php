...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-renamed:v1';
    const MIXINS = [
