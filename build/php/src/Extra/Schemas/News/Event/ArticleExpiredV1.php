...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-expired:v1';
    const MIXINS = [
