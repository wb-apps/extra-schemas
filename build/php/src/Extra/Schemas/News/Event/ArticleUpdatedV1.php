...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-updated:v1';
    const MIXINS = [
