...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-deleted:v1';
    const MIXINS = [
