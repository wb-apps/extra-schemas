...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-slotting-removed:v1';
    const MIXINS = [
