...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-locked:v1';
    const MIXINS = [
