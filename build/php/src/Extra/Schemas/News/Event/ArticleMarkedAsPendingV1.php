...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-marked-as-pending:v1';
    const MIXINS = [
