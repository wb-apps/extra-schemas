...
{
    const SCHEMA_ID = 'pbj:extra:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'extra:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'extra:news:request:get-article-response:v1';
    const MIXINS = [
