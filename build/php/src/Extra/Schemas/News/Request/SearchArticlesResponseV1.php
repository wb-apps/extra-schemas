...
{
    const SCHEMA_ID = 'pbj:extra:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'extra:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'extra:news:request:search-articles-response:v1';
    const MIXINS = [
