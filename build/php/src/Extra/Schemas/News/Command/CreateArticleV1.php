...
{
    const SCHEMA_ID = 'pbj:extra:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:create-article:v1';
    const MIXINS = [
