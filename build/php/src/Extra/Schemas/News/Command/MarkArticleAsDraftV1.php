...
{
    const SCHEMA_ID = 'pbj:extra:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:mark-article-as-draft:v1';
    const MIXINS = [
