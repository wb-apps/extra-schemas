...
{
    const SCHEMA_ID = 'pbj:extra:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:unpublish-article:v1';
    const MIXINS = [
