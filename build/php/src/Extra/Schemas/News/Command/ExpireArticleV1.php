...
{
    const SCHEMA_ID = 'pbj:extra:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:expire-article:v1';
    const MIXINS = [
