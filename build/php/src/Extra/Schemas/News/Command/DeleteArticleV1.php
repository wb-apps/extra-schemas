...
{
    const SCHEMA_ID = 'pbj:extra:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:delete-article:v1';
    const MIXINS = [
