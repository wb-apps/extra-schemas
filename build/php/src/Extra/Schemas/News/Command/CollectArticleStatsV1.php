...
{
    const SCHEMA_ID = 'pbj:extra:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:collect-article-stats:v1';
    const MIXINS = [
