...
{
    const SCHEMA_ID = 'pbj:extra:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:remove-article-slotting:v1';
    const MIXINS = [
