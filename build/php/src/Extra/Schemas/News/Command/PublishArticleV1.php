...
{
    const SCHEMA_ID = 'pbj:extra:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:publish-article:v1';
    const MIXINS = [
