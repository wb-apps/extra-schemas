...
{
    const SCHEMA_ID = 'pbj:extra:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'extra:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'extra:news:node:article-stats:v1';
    const MIXINS = [
