...
{
    const SCHEMA_ID = 'pbj:extra:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:get-person-history-request:v1';
    const MIXINS = [
