...
{
    const SCHEMA_ID = 'pbj:extra:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:search-people-response:v1';
    const MIXINS = [
