...
{
    const SCHEMA_ID = 'pbj:extra:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:get-person-history-response:v1';
    const MIXINS = [
