...
{
    const SCHEMA_ID = 'pbj:extra:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:get-person-response:v1';
    const MIXINS = [
