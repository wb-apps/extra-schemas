...
{
    const SCHEMA_ID = 'pbj:extra:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'extra:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'extra:people:command:create-person:v1';
    const MIXINS = [
