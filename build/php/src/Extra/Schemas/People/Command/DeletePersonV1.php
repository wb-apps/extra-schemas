...
{
    const SCHEMA_ID = 'pbj:extra:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'extra:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'extra:people:command:delete-person:v1';
    const MIXINS = [
