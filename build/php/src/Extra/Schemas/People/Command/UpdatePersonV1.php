...
{
    const SCHEMA_ID = 'pbj:extra:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'extra:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'extra:people:command:update-person:v1';
    const MIXINS = [
