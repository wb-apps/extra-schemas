...
{
    const SCHEMA_ID = 'pbj:extra:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'extra:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'extra:people:command:rename-person:v1';
    const MIXINS = [
