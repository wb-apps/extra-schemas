...
{
    const SCHEMA_ID = 'pbj:extra:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:people:event:person-updated:v1';
    const MIXINS = [
