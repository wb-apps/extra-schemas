...
{
    const SCHEMA_ID = 'pbj:extra:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:people:event:person-renamed:v1';
    const MIXINS = [
