...
{
    const SCHEMA_ID = 'pbj:extra:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:people:event:person-deleted:v1';
    const MIXINS = [
