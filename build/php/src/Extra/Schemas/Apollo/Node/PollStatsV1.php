...
{
    const SCHEMA_ID = 'pbj:extra:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:node:poll-stats:v1';
    const MIXINS = [
