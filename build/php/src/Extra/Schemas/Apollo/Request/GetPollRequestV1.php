...
{
    const SCHEMA_ID = 'pbj:extra:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:request:get-poll-request:v1';
    const MIXINS = [
