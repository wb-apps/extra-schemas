...
{
    const SCHEMA_ID = 'pbj:extra:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:request:get-poll-history-response:v1';
    const MIXINS = [
