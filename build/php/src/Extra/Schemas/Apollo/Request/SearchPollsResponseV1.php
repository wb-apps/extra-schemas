...
{
    const SCHEMA_ID = 'pbj:extra:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:request:search-polls-response:v1';
    const MIXINS = [
