...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:mark-poll-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:mark-poll-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:mark-poll-as-pending:v1';
    const MIXINS = [
