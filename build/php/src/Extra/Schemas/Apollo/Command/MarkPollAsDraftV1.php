...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:mark-poll-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:mark-poll-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:mark-poll-as-draft:v1';
    const MIXINS = [
