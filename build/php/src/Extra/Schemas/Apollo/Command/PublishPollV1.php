...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:publish-poll:v1';
    const MIXINS = [
