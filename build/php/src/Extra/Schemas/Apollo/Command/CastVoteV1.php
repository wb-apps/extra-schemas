...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:cast-vote:v1';
    const MIXINS = [
