...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:unpublish-poll:v1';
    const MIXINS = [
