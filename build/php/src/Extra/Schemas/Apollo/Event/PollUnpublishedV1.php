...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-unpublished:v1';
    const MIXINS = [
