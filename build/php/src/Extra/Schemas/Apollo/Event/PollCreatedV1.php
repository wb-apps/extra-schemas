...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-created:v1';
    const MIXINS = [
