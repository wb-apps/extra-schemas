...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:vote-casted:v1';
    const MIXINS = [
