...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-published:v1';
    const MIXINS = [
