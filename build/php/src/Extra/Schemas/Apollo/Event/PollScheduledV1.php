...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-scheduled:v1';
    const MIXINS = [
