...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-marked-as-draft:v1';
    const MIXINS = [
