...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-expired:v1';
    const MIXINS = [
