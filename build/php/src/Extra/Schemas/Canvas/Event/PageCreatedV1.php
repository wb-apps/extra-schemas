...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-created:v1';
    const MIXINS = [
