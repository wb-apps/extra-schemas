...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-marked-as-draft:v1';
    const MIXINS = [
