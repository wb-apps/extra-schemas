...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-deleted:v1';
    const MIXINS = [
