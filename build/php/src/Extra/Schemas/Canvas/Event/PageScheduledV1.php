...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-scheduled:v1';
    const MIXINS = [
