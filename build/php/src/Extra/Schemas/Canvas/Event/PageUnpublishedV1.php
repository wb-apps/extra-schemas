...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-unpublished:v1';
    const MIXINS = [
