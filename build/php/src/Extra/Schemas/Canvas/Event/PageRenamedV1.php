...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-renamed:v1';
    const MIXINS = [
