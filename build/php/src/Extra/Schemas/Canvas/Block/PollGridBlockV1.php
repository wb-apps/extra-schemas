...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:poll-grid-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:poll-grid-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:poll-grid-block:v1';
    const MIXINS = [
