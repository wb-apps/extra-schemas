...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:video-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:video-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:video-block:v1';
    const MIXINS = [
