...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:divider-block:v1';
    const MIXINS = [
