...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:tumblr-post-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:tumblr-post-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:tumblr-post-block:v1';
    const MIXINS = [
