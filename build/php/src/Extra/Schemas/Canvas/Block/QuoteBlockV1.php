...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:quote-block:v1';
    const MIXINS = [
