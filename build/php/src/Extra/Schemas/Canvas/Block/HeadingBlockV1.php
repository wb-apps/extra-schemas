...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:heading-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:heading-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:heading-block:v1';
    const MIXINS = [
