...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:code-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:code-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:code-block:v1';
    const MIXINS = [
