...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:iframe-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:iframe-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:iframe-block:v1';
    const MIXINS = [
