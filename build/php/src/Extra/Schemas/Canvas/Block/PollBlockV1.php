...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:poll-block:v1';
    const MIXINS = [
