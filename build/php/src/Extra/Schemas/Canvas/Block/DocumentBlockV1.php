...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:document-block:v1';
    const MIXINS = [
