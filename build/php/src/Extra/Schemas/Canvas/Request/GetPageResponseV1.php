...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:get-page-response:v1';
    const MIXINS = [
