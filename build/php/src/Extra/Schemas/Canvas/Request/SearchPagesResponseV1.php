...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:search-pages-response:v1';
    const MIXINS = [
