...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:get-page-request:v1';
    const MIXINS = [
