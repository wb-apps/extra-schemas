...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:get-page-history-response:v1';
    const MIXINS = [
