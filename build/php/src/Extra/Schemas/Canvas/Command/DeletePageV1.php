...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:delete-page:v1';
    const MIXINS = [
