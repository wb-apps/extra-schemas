...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:mark-page-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:mark-page-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:mark-page-as-draft:v1';
    const MIXINS = [
