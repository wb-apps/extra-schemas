...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:mark-page-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:mark-page-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:mark-page-as-pending:v1';
    const MIXINS = [
