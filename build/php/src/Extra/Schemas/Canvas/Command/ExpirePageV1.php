...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:expire-page:v1';
    const MIXINS = [
