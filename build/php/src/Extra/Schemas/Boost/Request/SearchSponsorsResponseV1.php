...
{
    const SCHEMA_ID = 'pbj:extra:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:request:search-sponsors-response:v1';
    const MIXINS = [
