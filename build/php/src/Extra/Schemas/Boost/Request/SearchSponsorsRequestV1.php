...
{
    const SCHEMA_ID = 'pbj:extra:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:request:search-sponsors-request:v1';
    const MIXINS = [
