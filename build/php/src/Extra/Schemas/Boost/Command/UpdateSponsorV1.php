...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:update-sponsor:v1';
    const MIXINS = [
