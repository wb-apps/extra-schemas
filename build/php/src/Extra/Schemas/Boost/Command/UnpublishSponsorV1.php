...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:unpublish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:unpublish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:unpublish-sponsor:v1';
    const MIXINS = [
