...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:expire-sponsor:v1';
    const MIXINS = [
