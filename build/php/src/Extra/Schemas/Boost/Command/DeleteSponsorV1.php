...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:delete-sponsor:v1';
    const MIXINS = [
