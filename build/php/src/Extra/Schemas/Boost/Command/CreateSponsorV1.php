...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:create-sponsor:v1';
    const MIXINS = [
