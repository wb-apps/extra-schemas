...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-deleted:v1';
    const MIXINS = [
