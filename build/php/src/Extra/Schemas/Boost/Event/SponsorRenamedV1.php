...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-renamed:v1';
    const MIXINS = [
