...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-published:v1';
    const MIXINS = [
