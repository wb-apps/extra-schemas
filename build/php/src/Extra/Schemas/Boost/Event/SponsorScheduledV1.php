...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-scheduled:v1';
    const MIXINS = [
