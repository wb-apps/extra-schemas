...
{
    const SCHEMA_ID = 'pbj:extra:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:event:notification-updated:v1';
    const MIXINS = [
