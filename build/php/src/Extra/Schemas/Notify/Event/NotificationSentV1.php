...
{
    const SCHEMA_ID = 'pbj:extra:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:event:notification-sent:v1';
    const MIXINS = [
