...
{
    const SCHEMA_ID = 'pbj:extra:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:event:notification-failed:v1';
    const MIXINS = [
