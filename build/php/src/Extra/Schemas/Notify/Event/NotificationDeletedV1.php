...
namespace Extra\Schemas\Notify\Event;
...
{
    const SCHEMA_ID = 'pbj:extra:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:event:notification-deleted:v1';
    const MIXINS = [
