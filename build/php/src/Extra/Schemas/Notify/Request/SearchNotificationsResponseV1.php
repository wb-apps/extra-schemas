...
{
    const SCHEMA_ID = 'pbj:extra:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:request:search-notifications-response:v1';
    const MIXINS = [
