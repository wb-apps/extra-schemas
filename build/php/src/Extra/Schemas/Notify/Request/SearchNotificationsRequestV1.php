...
{
    const SCHEMA_ID = 'pbj:extra:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:request:search-notifications-request:v1';
    const MIXINS = [
