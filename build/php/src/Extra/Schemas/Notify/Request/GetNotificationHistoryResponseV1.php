...
{
    const SCHEMA_ID = 'pbj:extra:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:request:get-notification-history-response:v1';
    const MIXINS = [
