...
{
    const SCHEMA_ID = 'pbj:extra:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:command:delete-notification:v1';
    const MIXINS = [
