...
{
    const SCHEMA_ID = 'pbj:extra:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:command:send-notification:v1';
    const MIXINS = [
