...
{
    const SCHEMA_ID = 'pbj:extra:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:command:update-notification:v1';
    const MIXINS = [
