...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:twitter-notification:v1';
    const MIXINS = [
