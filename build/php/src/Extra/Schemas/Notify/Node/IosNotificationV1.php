...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:ios-notification:v1';
    const MIXINS = [
