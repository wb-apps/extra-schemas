...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:android-notification:v1';
    const MIXINS = [
