...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:slack-notification:v1';
    const MIXINS = [
