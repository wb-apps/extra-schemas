...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:mark-sponsor-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:mark-sponsor-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:mark-sponsor-as-pending:v1';
    const MIXINS = [
