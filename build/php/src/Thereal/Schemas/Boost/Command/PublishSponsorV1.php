...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:publish-sponsor:v1';
    const MIXINS = [
