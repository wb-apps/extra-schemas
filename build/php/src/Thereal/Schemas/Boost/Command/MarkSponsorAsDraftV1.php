...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:mark-sponsor-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:mark-sponsor-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:mark-sponsor-as-draft:v1';
    const MIXINS = [
