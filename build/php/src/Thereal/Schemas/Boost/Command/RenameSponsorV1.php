...
{
    const SCHEMA_ID = 'pbj:extra:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:command:rename-sponsor:v1';
    const MIXINS = [
