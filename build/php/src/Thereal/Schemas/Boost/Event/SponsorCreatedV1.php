...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-created:v1';
    const MIXINS = [
