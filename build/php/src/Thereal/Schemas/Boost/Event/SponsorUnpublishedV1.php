...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-unpublished:v1';
    const MIXINS = [
