...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-updated:v1';
    const MIXINS = [
