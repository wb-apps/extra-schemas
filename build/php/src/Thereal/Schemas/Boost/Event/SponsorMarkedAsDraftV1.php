...
namespace extra\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-marked-as-draft:v1';
    const MIXINS = [
