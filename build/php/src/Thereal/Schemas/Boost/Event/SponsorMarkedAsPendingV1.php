...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
