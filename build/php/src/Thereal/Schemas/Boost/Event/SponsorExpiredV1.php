...
{
    const SCHEMA_ID = 'pbj:extra:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:event:sponsor-expired:v1';
    const MIXINS = [
