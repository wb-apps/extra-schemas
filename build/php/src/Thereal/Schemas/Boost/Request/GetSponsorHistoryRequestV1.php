...
{
    const SCHEMA_ID = 'pbj:extra:boost:request:get-sponsor-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:request:get-sponsor-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:request:get-sponsor-history-request:v1';
    const MIXINS = [
