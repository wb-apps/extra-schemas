...
{
    const SCHEMA_ID = 'pbj:extra:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:request:get-sponsor-response:v1';
    const MIXINS = [
