...
{
    const SCHEMA_ID = 'pbj:extra:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'extra:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'extra:boost:request:get-sponsor-request:v1';
    const MIXINS = [
