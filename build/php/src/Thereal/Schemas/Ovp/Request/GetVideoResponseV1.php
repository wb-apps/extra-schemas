...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:get-video-response:v1';
    const MIXINS = [
