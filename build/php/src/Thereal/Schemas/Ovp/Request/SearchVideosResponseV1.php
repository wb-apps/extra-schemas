...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:search-videos-response:v1';
    const MIXINS = [
