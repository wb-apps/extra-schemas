...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:get-video-request:v1';
    const MIXINS = [
