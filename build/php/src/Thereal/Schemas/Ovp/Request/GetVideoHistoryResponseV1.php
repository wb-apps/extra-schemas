...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:get-video-history-response:v1';
    const MIXINS = [
