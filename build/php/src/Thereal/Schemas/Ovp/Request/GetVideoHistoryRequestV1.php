...
{
    const SCHEMA_ID = 'pbj:extra:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:request:get-video-history-request:v1';
    const MIXINS = [
