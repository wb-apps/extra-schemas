...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:publish-video:v1';
    const MIXINS = [
