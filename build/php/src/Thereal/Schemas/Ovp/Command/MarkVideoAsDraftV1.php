...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:mark-video-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:mark-video-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:mark-video-as-draft:v1';
    const MIXINS = [
