...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:create-video:v1';
    const MIXINS = [
