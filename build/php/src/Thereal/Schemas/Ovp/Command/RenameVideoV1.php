...
{
    const SCHEMA_ID = 'pbj:extra:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:command:rename-video:v1';
    const MIXINS = [
