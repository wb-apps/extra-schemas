...
namespace extra\Schemas\Ovp\Event;
...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-marked-as-pending:v1';
    const MIXINS = [
