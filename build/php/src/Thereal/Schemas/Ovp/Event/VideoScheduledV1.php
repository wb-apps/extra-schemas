...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-scheduled:v1';
    const MIXINS = [
