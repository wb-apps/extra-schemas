...
{
    const SCHEMA_ID = 'pbj:extra:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'extra:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'extra:ovp:event:video-renamed:v1';
    const MIXINS = [
