...
namespace extra\Schemas\Notify\Command;
...
{
    const SCHEMA_ID = 'pbj:extra:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:command:create-notification:v1';
    const MIXINS = [
