...
{
    const SCHEMA_ID = 'pbj:extra:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:event:notification-created:v1';
    const MIXINS = [
