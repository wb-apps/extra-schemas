...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:sms-notification:v1';
    const MIXINS = [
