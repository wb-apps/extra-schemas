...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:email-notification:v1';
    const MIXINS = [
