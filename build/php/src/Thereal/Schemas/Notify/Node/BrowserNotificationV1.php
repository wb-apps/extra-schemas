...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:browser-notification:v1';
    const MIXINS = [
