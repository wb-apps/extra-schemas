...
{
    const SCHEMA_ID = 'pbj:extra:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:node:apple-news-notification:v1';
    const MIXINS = [
