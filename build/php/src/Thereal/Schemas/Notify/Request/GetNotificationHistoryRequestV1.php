...
{
    const SCHEMA_ID = 'pbj:extra:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:request:get-notification-history-request:v1';
    const MIXINS = [
