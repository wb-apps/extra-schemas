...
{
    const SCHEMA_ID = 'pbj:extra:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'extra:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'extra:notify:request:get-notification-request:v1';
    const MIXINS = [
