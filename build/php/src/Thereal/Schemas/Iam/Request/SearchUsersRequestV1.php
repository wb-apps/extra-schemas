...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:search-users-request:v1';
    const MIXINS = [
