...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:get-user-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:get-user-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:get-user-history-request:v1';
    const MIXINS = [
