...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:list-all-roles-request:v1';
    const MIXINS = [
