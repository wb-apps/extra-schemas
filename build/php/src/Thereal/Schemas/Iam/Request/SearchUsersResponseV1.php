...
{
    const SCHEMA_ID = 'pbj:extra:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:request:search-users-response:v1';
    const MIXINS = [
