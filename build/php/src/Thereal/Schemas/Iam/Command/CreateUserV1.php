...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:create-user:v1';
    const MIXINS = [
