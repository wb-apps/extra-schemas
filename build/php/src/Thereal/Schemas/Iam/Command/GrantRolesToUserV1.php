...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:grant-roles-to-user:v1';
    const MIXINS = [
