...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:delete-role:v1';
    const MIXINS = [
