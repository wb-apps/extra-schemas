...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:update-app:v1';
    const MIXINS = [
