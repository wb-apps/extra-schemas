...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:delete-user:v1';
    const MIXINS = [
