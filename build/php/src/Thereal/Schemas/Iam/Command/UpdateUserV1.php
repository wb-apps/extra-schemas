...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:update-user:v1';
    const MIXINS = [
