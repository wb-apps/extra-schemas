...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:create-role:v1';
    const MIXINS = [
