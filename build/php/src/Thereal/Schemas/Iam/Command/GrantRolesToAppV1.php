...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:grant-roles-to-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:grant-roles-to-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:grant-roles-to-app:v1';
    const MIXINS = [
