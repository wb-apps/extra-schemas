...
{
    const SCHEMA_ID = 'pbj:extra:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:command:delete-app:v1';
    const MIXINS = [
