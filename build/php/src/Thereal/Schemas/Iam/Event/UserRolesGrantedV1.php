...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:user-roles-granted:v1';
    const MIXINS = [
