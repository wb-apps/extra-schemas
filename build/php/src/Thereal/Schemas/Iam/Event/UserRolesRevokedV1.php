...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:user-roles-revoked:v1';
    const MIXINS = [
