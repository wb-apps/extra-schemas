...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:user-created:v1';
    const MIXINS = [
