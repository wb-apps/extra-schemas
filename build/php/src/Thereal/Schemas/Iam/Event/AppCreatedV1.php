...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:app-created:v1';
    const MIXINS = [
