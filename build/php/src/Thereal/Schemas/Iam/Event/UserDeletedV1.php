...
{
    const SCHEMA_ID = 'pbj:extra:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:event:user-deleted:v1';
    const MIXINS = [
