...
{
    const SCHEMA_ID = 'pbj:extra:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'extra:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'extra:iam:node:apple-news-app:v1';
    const MIXINS = [
