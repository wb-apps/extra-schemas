...
{
    const SCHEMA_ID = 'pbj:extra:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:event:picklist-created:v1';
    const MIXINS = [
