...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-flagset-request:v1';
    const MIXINS = [
