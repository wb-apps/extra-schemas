...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-flagset-response:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-flagset-response';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-flagset-response:v1';
    const MIXINS = [
