...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:get-picklist-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:get-picklist-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:get-picklist-history-request:v1';
    const MIXINS = [
