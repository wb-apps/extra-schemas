...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:list-all-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:list-all-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:list-all-picklists-request:v1';
    const MIXINS = [
