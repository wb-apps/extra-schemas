...
{
    const SCHEMA_ID = 'pbj:extra:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:request:search-redirects-request:v1';
    const MIXINS = [
