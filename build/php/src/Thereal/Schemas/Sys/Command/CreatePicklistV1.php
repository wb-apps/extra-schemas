...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:create-picklist:v1';
    const MIXINS = [
