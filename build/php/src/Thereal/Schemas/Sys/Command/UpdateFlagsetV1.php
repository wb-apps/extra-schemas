...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:update-flagset:v1';
    const MIXINS = [
