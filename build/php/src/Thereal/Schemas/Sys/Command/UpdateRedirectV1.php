...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:update-redirect:v1';
    const MIXINS = [
