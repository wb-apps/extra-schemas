...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:create-redirect:v1';
    const MIXINS = [
