...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:update-picklist:v1';
    const MIXINS = [
