...
{
    const SCHEMA_ID = 'pbj:extra:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'extra:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'extra:sys:command:delete-redirect:v1';
    const MIXINS = [
