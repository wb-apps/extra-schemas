...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:node:category:v1';
    const MIXINS = [
