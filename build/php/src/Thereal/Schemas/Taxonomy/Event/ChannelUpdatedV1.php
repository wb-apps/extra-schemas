...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:channel-updated:v1';
    const MIXINS = [
