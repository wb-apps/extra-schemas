...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:channel-created:v1';
    const MIXINS = [
