...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:event:category-deleted:v1';
    const MIXINS = [
