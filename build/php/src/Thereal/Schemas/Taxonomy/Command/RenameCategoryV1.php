...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:rename-category:v1';
    const MIXINS = [
