...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:delete-channel:v1';
    const MIXINS = [
