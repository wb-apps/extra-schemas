...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:delete-category:v1';
    const MIXINS = [
