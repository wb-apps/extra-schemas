...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:create-channel:v1';
    const MIXINS = [
