...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:rename-channel:v1';
    const MIXINS = [
