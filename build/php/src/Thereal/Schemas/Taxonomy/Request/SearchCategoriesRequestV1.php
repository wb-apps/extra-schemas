...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:search-categories-request:v1';
    const MIXINS = [
