...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:get-category-response:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:get-category-response';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:get-category-response:v1';
    const MIXINS = [
