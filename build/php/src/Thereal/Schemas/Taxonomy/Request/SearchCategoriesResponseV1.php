...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:search-categories-response:v1';
    const MIXINS = [
