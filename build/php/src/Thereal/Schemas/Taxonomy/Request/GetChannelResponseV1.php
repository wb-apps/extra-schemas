...
{
    const SCHEMA_ID = 'pbj:extra:taxonomy:request:get-channel-response:1-0-0';
    const SCHEMA_CURIE = 'extra:taxonomy:request:get-channel-response';
    const SCHEMA_CURIE_MAJOR = 'extra:taxonomy:request:get-channel-response:v1';
    const MIXINS = [
