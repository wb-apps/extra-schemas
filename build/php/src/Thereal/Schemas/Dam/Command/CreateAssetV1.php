...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:create-asset:v1';
    const MIXINS = [
