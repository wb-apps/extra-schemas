...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:patch-assets:v1';
    const MIXINS = [
