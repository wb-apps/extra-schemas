...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:delete-asset:v1';
    const MIXINS = [
