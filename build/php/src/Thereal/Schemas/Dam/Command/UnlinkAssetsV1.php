...
namespace extra\Schemas\Dam\Command;
...
{
    const SCHEMA_ID = 'pbj:extra:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:command:unlink-assets:v1';
    const MIXINS = [
