...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:asset-unlinked:v1';
    const MIXINS = [
