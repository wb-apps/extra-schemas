...
{
    const SCHEMA_ID = 'pbj:extra:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
