...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:video-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:video-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:video-asset:v1';
    const MIXINS = [
