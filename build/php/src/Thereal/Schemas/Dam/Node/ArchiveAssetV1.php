...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:archive-asset:v1';
    const MIXINS = [
