...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:audio-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:audio-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:audio-asset:v1';
    const MIXINS = [
