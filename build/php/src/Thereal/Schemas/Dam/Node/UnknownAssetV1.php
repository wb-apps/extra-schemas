...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:unknown-asset:v1';
    const MIXINS = [
