...
{
    const SCHEMA_ID = 'pbj:extra:dam:node:image-asset:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:node:image-asset';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:node:image-asset:v1';
    const MIXINS = [
