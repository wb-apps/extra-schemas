...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:search-assets-response:v1';
    const MIXINS = [
