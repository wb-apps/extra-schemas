...
{
    const SCHEMA_ID = 'pbj:extra:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'extra:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'extra:dam:request:search-assets-request:v1';
    const MIXINS = [
