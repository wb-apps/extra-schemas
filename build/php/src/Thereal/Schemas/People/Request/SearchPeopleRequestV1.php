...
{
    const SCHEMA_ID = 'pbj:extra:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:search-people-request:v1';
    const MIXINS = [
