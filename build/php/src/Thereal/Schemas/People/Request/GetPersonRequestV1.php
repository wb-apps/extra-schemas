...
{
    const SCHEMA_ID = 'pbj:extra:people:request:get-person-request:1-0-0';
    const SCHEMA_CURIE = 'extra:people:request:get-person-request';
    const SCHEMA_CURIE_MAJOR = 'extra:people:request:get-person-request:v1';
    const MIXINS = [
