...
namespace extra\Schemas\People\Event;
...
{
    const SCHEMA_ID = 'pbj:extra:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'extra:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'extra:people:event:person-created:v1';
    const MIXINS = [
