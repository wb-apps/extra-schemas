...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:gridler-widget:v1';
    const MIXINS = [
