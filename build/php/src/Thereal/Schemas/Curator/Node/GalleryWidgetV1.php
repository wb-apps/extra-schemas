...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:gallery-widget:v1';
    const MIXINS = [
