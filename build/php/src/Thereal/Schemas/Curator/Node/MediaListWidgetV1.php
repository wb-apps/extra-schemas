...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:media-list-widget:v1';
    const MIXINS = [
