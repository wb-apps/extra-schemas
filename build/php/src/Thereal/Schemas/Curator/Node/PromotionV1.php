...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:promotion:v1';
    const MIXINS = [
