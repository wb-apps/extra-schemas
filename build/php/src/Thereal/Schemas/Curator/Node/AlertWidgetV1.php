...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:alert-widget:v1';
    const MIXINS = [
