...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:tag-cloud-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:tag-cloud-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:tag-cloud-widget:v1';
    const MIXINS = [
