...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:video-teaser:v1';
    const MIXINS = [
