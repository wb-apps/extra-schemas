...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:blogroll-widget:v1';
    const MIXINS = [
