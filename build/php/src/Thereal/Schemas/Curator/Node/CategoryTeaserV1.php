...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:category-teaser:v1';
    const MIXINS = [
