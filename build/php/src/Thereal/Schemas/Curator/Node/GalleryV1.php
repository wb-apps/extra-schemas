...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:gallery:v1';
    const MIXINS = [
