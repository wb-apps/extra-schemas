...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:hero-bar-widget:v1';
    const MIXINS = [
