...
{
    const SCHEMA_ID = 'pbj:extra:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:node:asset-teaser:v1';
    const MIXINS = [
