...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:render-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:render-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:render-promotion-request:v1';
    const MIXINS = [
