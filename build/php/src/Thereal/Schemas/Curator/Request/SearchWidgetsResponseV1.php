...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-widgets-response:v1';
    const MIXINS = [
