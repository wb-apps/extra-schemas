...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-widget-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-widget-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-widget-history-request:v1';
    const MIXINS = [
