...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-timeline-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-timeline-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-timeline-request:v1';
    const MIXINS = [
