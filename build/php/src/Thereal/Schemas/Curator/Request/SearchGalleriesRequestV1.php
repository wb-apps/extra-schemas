...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:search-galleries-request:v1';
    const MIXINS = [
