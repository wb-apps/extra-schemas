...
{
    const SCHEMA_ID = 'pbj:extra:curator:request:get-gallery-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:request:get-gallery-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:request:get-gallery-history-request:v1';
    const MIXINS = [
