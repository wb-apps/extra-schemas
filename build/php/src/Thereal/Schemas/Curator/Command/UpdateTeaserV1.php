...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-teaser:v1';
    const MIXINS = [
