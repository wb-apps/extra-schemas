...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:remove-teaser-slotting:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:remove-teaser-slotting';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:remove-teaser-slotting:v1';
    const MIXINS = [
