...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:delete-gallery:v1';
    const MIXINS = [
