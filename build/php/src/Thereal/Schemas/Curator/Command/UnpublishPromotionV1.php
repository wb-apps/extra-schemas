...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:unpublish-promotion:v1';
    const MIXINS = [
