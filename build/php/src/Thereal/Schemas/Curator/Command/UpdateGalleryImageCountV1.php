...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-gallery-image-count:v1';
    const MIXINS = [
