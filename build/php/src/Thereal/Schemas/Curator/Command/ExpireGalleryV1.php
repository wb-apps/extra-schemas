...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:expire-gallery:v1';
    const MIXINS = [
