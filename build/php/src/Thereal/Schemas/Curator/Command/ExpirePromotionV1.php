...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:expire-promotion:v1';
    const MIXINS = [
