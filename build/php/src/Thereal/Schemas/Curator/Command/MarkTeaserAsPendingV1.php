...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:mark-teaser-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:mark-teaser-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:mark-teaser-as-pending:v1';
    const MIXINS = [
