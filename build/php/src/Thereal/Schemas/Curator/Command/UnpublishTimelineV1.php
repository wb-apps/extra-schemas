...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:unpublish-timeline:v1';
    const MIXINS = [
