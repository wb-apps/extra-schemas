...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:create-teaser:v1';
    const MIXINS = [
