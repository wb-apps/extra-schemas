...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:publish-teaser:v1';
    const MIXINS = [
