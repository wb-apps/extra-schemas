...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:publish-gallery:v1';
    const MIXINS = [
