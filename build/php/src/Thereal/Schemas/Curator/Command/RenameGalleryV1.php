...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:rename-gallery:v1';
    const MIXINS = [
