...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:delete-teaser:v1';
    const MIXINS = [
