...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:create-widget:v1';
    const MIXINS = [
