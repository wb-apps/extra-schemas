...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:rename-timeline:v1';
    const MIXINS = [
