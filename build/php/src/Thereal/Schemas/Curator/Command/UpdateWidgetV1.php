...
{
    const SCHEMA_ID = 'pbj:extra:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:command:update-widget:v1';
    const MIXINS = [
