...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-created:v1';
    const MIXINS = [
