...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-marked-as-draft:v1';
    const MIXINS = [
