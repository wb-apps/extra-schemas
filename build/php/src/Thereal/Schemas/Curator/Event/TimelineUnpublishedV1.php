...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-unpublished:v1';
    const MIXINS = [
