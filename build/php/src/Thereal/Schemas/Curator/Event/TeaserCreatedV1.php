...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-created:v1';
    const MIXINS = [
