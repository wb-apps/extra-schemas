...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-published:v1';
    const MIXINS = [
