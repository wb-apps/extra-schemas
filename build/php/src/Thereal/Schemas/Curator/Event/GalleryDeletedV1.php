...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-deleted:v1';
    const MIXINS = [
