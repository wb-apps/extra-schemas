...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-unpublished:v1';
    const MIXINS = [
