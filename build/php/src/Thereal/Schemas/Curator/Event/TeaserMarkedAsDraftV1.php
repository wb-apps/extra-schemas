...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:teaser-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:teaser-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:teaser-marked-as-draft:v1';
    const MIXINS = [
