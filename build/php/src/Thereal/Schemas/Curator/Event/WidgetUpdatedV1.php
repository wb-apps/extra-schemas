...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:widget-updated:v1';
    const MIXINS = [
