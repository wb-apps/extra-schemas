...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:timeline-updated:v1';
    const MIXINS = [
