...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-created:v1';
    const MIXINS = [
