...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:gallery-scheduled:v1';
    const MIXINS = [
