...
{
    const SCHEMA_ID = 'pbj:extra:curator:event:promotion-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:curator:event:promotion-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:curator:event:promotion-marked-as-pending:v1';
    const MIXINS = [
