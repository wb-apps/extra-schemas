...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:rename-page:v1';
    const MIXINS = [
