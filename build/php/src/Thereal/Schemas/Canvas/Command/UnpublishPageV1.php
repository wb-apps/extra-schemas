...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:unpublish-page:v1';
    const MIXINS = [
