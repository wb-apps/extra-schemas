...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:publish-page:v1';
    const MIXINS = [
