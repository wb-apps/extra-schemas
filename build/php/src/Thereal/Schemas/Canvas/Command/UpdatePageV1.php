...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:update-page:v1';
    const MIXINS = [
