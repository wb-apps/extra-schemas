...
{
    const SCHEMA_ID = 'pbj:extra:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:command:create-page:v1';
    const MIXINS = [
