...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:article-block:v1';
    const MIXINS = [
