...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:gallery-block:v1';
    const MIXINS = [
