...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:facebook-video-block:v1';
    const MIXINS = [
