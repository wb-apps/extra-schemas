...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:youtube-playlist-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:youtube-playlist-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:youtube-playlist-block:v1';
    const MIXINS = [
