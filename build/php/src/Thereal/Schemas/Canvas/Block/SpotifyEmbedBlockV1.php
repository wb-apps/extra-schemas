...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:spotify-embed-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:spotify-embed-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:spotify-embed-block:v1';
    const MIXINS = [
