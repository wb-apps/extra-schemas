...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:vimeo-video-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:vimeo-video-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:vimeo-video-block:v1';
    const MIXINS = [
