...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:twitter-tweet-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:twitter-tweet-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:twitter-tweet-block:v1';
    const MIXINS = [
