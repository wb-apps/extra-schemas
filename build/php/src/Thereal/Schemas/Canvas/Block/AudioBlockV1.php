...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:audio-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:audio-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:audio-block:v1';
    const MIXINS = [
