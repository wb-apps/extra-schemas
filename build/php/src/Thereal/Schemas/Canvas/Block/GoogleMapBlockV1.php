...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:google-map-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:google-map-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:google-map-block:v1';
    const MIXINS = [
