...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:imgur-post-block:v1';
    const MIXINS = [
