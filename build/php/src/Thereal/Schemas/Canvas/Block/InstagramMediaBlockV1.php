...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:instagram-media-block:v1';
    const MIXINS = [
