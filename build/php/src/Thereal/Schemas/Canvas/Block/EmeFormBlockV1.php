...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:eme-form-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:eme-form-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:eme-form-block:v1';
    const MIXINS = [
