...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:image-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:image-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:image-block:v1';
    const MIXINS = [
