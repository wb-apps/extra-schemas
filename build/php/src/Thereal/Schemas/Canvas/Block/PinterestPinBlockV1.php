...
{
    const SCHEMA_ID = 'pbj:extra:canvas:block:pinterest-pin-block:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:block:pinterest-pin-block';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:block:pinterest-pin-block:v1';
    const MIXINS = [
