...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-expired:v1';
    const MIXINS = [
