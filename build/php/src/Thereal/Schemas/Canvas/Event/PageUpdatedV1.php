...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-updated:v1';
    const MIXINS = [
