...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-published:v1';
    const MIXINS = [
