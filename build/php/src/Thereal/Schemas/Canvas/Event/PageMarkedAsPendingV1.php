...
{
    const SCHEMA_ID = 'pbj:extra:canvas:event:page-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:event:page-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:event:page-marked-as-pending:v1';
    const MIXINS = [
