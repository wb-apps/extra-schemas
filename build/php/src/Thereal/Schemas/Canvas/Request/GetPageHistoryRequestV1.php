...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:get-page-history-request:v1';
    const MIXINS = [
