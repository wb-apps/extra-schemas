...
{
    const SCHEMA_ID = 'pbj:extra:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'extra:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'extra:canvas:request:search-pages-request:v1';
    const MIXINS = [
