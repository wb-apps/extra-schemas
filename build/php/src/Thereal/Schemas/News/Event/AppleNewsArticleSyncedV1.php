...
{
    const SCHEMA_ID = 'pbj:extra:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:apple-news-article-synced:v1';
    const MIXINS = [
