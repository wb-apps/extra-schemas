...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-unpublished:v1';
    const MIXINS = [
