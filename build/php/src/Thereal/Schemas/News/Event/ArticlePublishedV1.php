...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-published:v1';
    const MIXINS = [
