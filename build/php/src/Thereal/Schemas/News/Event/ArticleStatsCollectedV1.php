...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-stats-collected:v1';
    const MIXINS = [
