...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-marked-as-draft:v1';
    const MIXINS = [
