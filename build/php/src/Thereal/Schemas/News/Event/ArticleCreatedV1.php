...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-created:v1';
    const MIXINS = [
