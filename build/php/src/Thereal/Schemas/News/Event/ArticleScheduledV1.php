...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-scheduled:v1';
    const MIXINS = [
