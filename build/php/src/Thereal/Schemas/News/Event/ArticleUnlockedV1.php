...
{
    const SCHEMA_ID = 'pbj:extra:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'extra:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'extra:news:event:article-unlocked:v1';
    const MIXINS = [
