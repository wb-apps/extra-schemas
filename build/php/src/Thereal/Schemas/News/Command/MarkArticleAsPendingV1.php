...
{
    const SCHEMA_ID = 'pbj:extra:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:mark-article-as-pending:v1';
    const MIXINS = [
