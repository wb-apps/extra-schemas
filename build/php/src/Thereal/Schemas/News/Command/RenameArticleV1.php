...
{
    const SCHEMA_ID = 'pbj:extra:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:rename-article:v1';
    const MIXINS = [
