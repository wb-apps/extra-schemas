...
{
    const SCHEMA_ID = 'pbj:extra:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:update-article:v1';
    const MIXINS = [
