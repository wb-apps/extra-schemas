...
{
    const SCHEMA_ID = 'pbj:extra:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:unlock-article:v1';
    const MIXINS = [
