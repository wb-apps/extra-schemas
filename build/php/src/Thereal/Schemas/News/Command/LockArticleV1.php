...
{
    const SCHEMA_ID = 'pbj:extra:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'extra:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'extra:news:command:lock-article:v1';
    const MIXINS = [
