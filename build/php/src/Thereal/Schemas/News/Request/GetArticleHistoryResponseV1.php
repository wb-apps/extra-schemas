...
{
    const SCHEMA_ID = 'pbj:extra:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'extra:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'extra:news:request:get-article-history-response:v1';
    const MIXINS = [
