...
{
    const SCHEMA_ID = 'pbj:extra:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'extra:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'extra:news:request:search-articles-request:v1';
    const MIXINS = [
