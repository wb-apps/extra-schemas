...
{
    const SCHEMA_ID = 'pbj:extra:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'extra:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'extra:news:request:get-article-request:v1';
    const MIXINS = [
