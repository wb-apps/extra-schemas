...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:create-poll:v1';
    const MIXINS = [
