...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:delete-poll:v1';
    const MIXINS = [
