...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:update-poll:v1';
    const MIXINS = [
