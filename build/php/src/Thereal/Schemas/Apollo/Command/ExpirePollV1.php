...
{
    const SCHEMA_ID = 'pbj:extra:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:command:expire-poll:v1';
    const MIXINS = [
