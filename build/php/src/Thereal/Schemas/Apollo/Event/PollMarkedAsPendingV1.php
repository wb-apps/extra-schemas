...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [
