...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-deleted:v1';
    const MIXINS = [
