...
{
    const SCHEMA_ID = 'pbj:extra:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:event:poll-updated:v1';
    const MIXINS = [
