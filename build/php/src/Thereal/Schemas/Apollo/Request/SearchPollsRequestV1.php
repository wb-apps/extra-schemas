...
{
    const SCHEMA_ID = 'pbj:extra:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'extra:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'extra:apollo:request:search-polls-request:v1';
    const MIXINS = [
