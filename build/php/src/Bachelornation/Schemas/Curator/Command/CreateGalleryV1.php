<?php
// @link https://schemas.extra.com/json-schema/extra/curator/command/create-gallery/1-0-0.json#
    ...
    GdbotsNcrCreateNodeV1
{
    ...
    {
        return new Schema('pbj:extra:curator:command:create-gallery:1-0-0', __CLASS__,
            [],
            [
