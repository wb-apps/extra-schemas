<?php
// @link https://schemas.extra.com/json-schema/extra/curator/command/update-teaser/1-0-0.json#
    ...
    GdbotsNcrUpdateNodeV1
{
    ...
    {
        return new Schema('pbj:extra:curator:command:update-teaser:1-0-0', __CLASS__,
            [],
            [
