<?php
// @link https://schemas.extra.com/json-schema/extra/curator/command/expire-timeline/1-0-0.json#
    ...
    GdbotsNcrExpireNodeV1
{
    ...
    {
        return new Schema('pbj:extra:curator:command:expire-timeline:1-0-0', __CLASS__,
            [],
            [
