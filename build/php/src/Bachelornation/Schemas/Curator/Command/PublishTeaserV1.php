<?php
// @link https://schemas.extra.com/json-schema/extra/curator/command/publish-teaser/1-0-0.json#
    ...
    GdbotsNcrPublishNodeV1
{
    ...
    {
        return new Schema('pbj:extra:curator:command:publish-teaser:1-0-0', __CLASS__,
            [],
            [
