<?php
// @link https://schemas.extra.com/json-schema/extra/ovp/command/mark-video-as-draft/1-0-0.json#
    ...
    GdbotsNcrMarkNodeAsDraftV1
{
    ...
    {
        return new Schema('pbj:extra:ovp:command:mark-video-as-draft:1-0-0', __CLASS__,
            [],
            [
