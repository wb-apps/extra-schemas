<?php
// @link https://schemas.extra.com/json-schema/extra/ovp/event/video-scheduled/1-0-0.json#
    ...
    GdbotsEnrichmentsTimeSamplingV1
{
    ...
    {
        return new Schema('pbj:extra:ovp:event:video-scheduled:1-0-0', __CLASS__,
            [],
            [
