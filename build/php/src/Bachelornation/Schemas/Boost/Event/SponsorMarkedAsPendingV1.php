<?php
// @link https://schemas.extra.com/json-schema/extra/boost/event/sponsor-marked-as-pending/1-0-0.json#
    ...
    GdbotsNcrNodeMarkedAsPendingV1
{
    ...
    {
        return new Schema('pbj:extra:boost:event:sponsor-marked-as-pending:1-0-0', __CLASS__,
            [],
            [
