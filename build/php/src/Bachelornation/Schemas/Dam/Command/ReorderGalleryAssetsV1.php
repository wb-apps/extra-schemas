<?php
// @link https://schemas.extra.com/json-schema/extra/dam/command/reorder-gallery-assets/1-0-0.json#
    ...
    TrinitiDamReorderGalleryAssetsV1
{
    ...
    {
        return new Schema('pbj:extra:dam:command:reorder-gallery-assets:1-0-0', __CLASS__,
            [],
            [
