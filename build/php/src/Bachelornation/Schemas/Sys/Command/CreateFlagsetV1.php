<?php
// @link https://schemas.extra.com/json-schema/extra/sys/command/create-flagset/1-0-0.json#
    ...
    GdbotsNcrCreateNodeV1
{
    ...
    {
        return new Schema('pbj:extra:sys:command:create-flagset:1-0-0', __CLASS__,
            [],
            [
