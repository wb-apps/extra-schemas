<?php
// @link https://schemas.extra.com/json-schema/extra/apollo/command/mark-poll-as-pending/1-0-0.json#
    ...
    GdbotsNcrMarkNodeAsPendingV1
{
    ...
    {
        return new Schema('pbj:extra:apollo:command:mark-poll-as-pending:1-0-0', __CLASS__,
            [],
            [
