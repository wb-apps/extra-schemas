<?php
// @link https://schemas.extra.com/json-schema/extra/iam/event/user-roles-granted/1-0-0.json#
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:extra:iam:event:user-roles-granted:1-0-0', __CLASS__,
            [],
            [
