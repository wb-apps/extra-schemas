<?php
// @link https://schemas.extra.com/json-schema/extra/canvas/block/poll-grid-block/1-0-0.json#
    ...
    TrinitiCanvasPollGridBlockV1
{
    ...
    {
        return new Schema('pbj:extra:canvas:block:poll-grid-block:1-0-0', __CLASS__,
            [],
            [
