<?php
// @link https://schemas.extra.com/json-schema/extra/canvas/command/create-page/1-0-0.json#
    ...
    GdbotsNcrCreateNodeV1
{
    ...
    {
        return new Schema('pbj:extra:canvas:command:create-page:1-0-0', __CLASS__,
            [],
            [
