<?php
// @link https://schemas.extra.com/json-schema/extra/people/request/get-person-response/1-0-0.json#
    ...
    GdbotsNcrGetNodeResponseV1
{
    ...
    {
        return new Schema('pbj:extra:people:request:get-person-response:1-0-0', __CLASS__,
            [],
            [
