...
const M = PageV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:canvas:node:page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:canvas:node:page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:canvas:node:page:v1';
