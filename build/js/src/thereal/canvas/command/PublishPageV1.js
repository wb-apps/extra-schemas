// @link https://schemas.extratv.com/json-schema/extra/canvas/command/publish-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:canvas:command:publish-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:canvas:command:publish-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:canvas:command:publish-page:v1';
