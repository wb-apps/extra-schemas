...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:canvas:command:create-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:canvas:command:create-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:canvas:command:create-page:v1';
