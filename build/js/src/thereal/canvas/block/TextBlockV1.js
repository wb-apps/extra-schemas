// @link https://schemas.extratv.com/json-schema/extra/canvas/block/text-block/1-0-0.json#
...
const M = TextBlockV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:canvas:block:text-block:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:canvas:block:text-block';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:canvas:block:text-block:v1';
