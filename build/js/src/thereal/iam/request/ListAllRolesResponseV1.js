...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:request:list-all-roles-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:request:list-all-roles-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:request:list-all-roles-response:v1';
