// @link https://schemas.extratv.com/json-schema/extra/iam/request/get-user-response/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:request:get-user-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:request:get-user-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:request:get-user-response:v1';
