...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:command:create-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:command:create-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:command:create-user:v1';
