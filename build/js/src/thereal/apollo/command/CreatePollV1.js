// @link https://schemas.extratv.com/json-schema/extra/apollo/command/create-poll/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:apollo:command:create-poll:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:apollo:command:create-poll';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:apollo:command:create-poll:v1';
