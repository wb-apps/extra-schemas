...
const M = CastVoteV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:apollo:command:cast-vote:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:apollo:command:cast-vote';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:apollo:command:cast-vote:v1';
