// @link https://schemas.extratv.com/json-schema/extra/sys/command/create-picklist/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:sys:command:create-picklist:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:sys:command:create-picklist';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:sys:command:create-picklist:v1';
