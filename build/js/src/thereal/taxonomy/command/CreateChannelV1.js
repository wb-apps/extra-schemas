// @link https://schemas.extratv.com/json-schema/extra/taxonomy/command/create-channel/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:taxonomy:command:create-channel:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:taxonomy:command:create-channel';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:taxonomy:command:create-channel:v1';
