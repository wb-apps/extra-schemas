...
export default class PageUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:event:page-unpublished:1-0-0', PageUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:canvas:event:page-unpublished', PageUnpublishedV1);
