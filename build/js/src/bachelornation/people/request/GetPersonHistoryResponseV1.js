...
export default class GetPersonHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:request:get-person-history-response:1-0-0', GetPersonHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:people:request:get-person-history-response', GetPersonHistoryResponseV1);
