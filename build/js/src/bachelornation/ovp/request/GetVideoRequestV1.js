// @link https://schemas.extra.com/json-schema/extra/ovp/request/get-video-request/1-0-0.json#
...
export default class GetVideoRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:request:get-video-request:1-0-0', GetVideoRequestV1,
      [],
      [
...
MessageResolver.register('extra:ovp:request:get-video-request', GetVideoRequestV1);
