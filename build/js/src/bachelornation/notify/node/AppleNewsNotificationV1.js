...
export default class AppleNewsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:apple-news-notification:1-0-0', AppleNewsNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:apple-news-notification', AppleNewsNotificationV1);
