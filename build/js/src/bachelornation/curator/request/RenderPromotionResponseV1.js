// @link https://schemas.extra.com/json-schema/extra/curator/request/render-promotion-response/1-0-0.json#
...
export default class RenderPromotionResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:render-promotion-response:1-0-0', RenderPromotionResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:render-promotion-response', RenderPromotionResponseV1);
