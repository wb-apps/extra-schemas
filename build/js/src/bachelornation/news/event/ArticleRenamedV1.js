// @link https://schemas.extra.com/json-schema/extra/news/event/article-renamed/1-0-0.json#
...
export default class ArticleRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-renamed:1-0-0', ArticleRenamedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-renamed', ArticleRenamedV1);
