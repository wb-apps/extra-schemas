// @link https://schemas.extra.com/json-schema/extra/iam/node/ios-app/1-0-0.json#
...
export default class IosAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:node:ios-app:1-0-0', IosAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:node:ios-app', IosAppV1);
