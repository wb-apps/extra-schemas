// @link https://schemas.extra.com/json-schema/extra/iam/request/get-all-apps-response/1-0-0.json#
...
export default class GetAllAppsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-all-apps-response:1-0-0', GetAllAppsResponseV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-all-apps-response', GetAllAppsResponseV1);
