// @link https://schemas.extra.com/json-schema/extra/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('extra:apollo:node:poll', PollV1);
