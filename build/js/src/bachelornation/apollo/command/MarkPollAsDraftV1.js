...
export default class MarkPollAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:command:mark-poll-as-draft:1-0-0', MarkPollAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:apollo:command:mark-poll-as-draft', MarkPollAsDraftV1);
