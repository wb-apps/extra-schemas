// @link https://schemas.extra.com/json-schema/extra/sys/command/create-redirect/1-0-0.json#
...
export default class CreateRedirectV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:create-redirect:1-0-0', CreateRedirectV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:create-redirect', CreateRedirectV1);
