// @link https://schemas.extra.com/json-schema/extra/sys/command/update-flagset/1-0-0.json#
...
export default class UpdateFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:update-flagset:1-0-0', UpdateFlagsetV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:update-flagset', UpdateFlagsetV1);
