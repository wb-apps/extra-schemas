...
export default class RenameSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:rename-sponsor:1-0-0', RenameSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:rename-sponsor', RenameSponsorV1);
