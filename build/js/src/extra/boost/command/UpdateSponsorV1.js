...
export default class UpdateSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:update-sponsor:1-0-0', UpdateSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:update-sponsor', UpdateSponsorV1);
