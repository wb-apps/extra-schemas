...
export default class UnpublishSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:unpublish-sponsor:1-0-0', UnpublishSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:unpublish-sponsor', UnpublishSponsorV1);
