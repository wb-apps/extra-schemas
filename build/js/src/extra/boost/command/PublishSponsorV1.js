...
export default class PublishSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:publish-sponsor:1-0-0', PublishSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:publish-sponsor', PublishSponsorV1);
