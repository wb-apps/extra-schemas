...
export default class MarkSponsorAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:mark-sponsor-as-draft:1-0-0', MarkSponsorAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:mark-sponsor-as-draft', MarkSponsorAsDraftV1);
