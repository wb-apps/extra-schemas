...
export default class DeleteSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:delete-sponsor:1-0-0', DeleteSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:delete-sponsor', DeleteSponsorV1);
