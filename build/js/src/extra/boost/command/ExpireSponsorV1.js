...
export default class ExpireSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:expire-sponsor:1-0-0', ExpireSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:expire-sponsor', ExpireSponsorV1);
