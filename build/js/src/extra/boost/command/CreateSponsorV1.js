...
export default class CreateSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:create-sponsor:1-0-0', CreateSponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:create-sponsor', CreateSponsorV1);
