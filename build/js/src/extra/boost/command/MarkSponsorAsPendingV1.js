...
export default class MarkSponsorAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:command:mark-sponsor-as-pending:1-0-0', MarkSponsorAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:boost:command:mark-sponsor-as-pending', MarkSponsorAsPendingV1);
