...
export default class GetSponsorHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:get-sponsor-history-request:1-0-0', GetSponsorHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:get-sponsor-history-request', GetSponsorHistoryRequestV1);
