...
export default class SearchSponsorsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:search-sponsors-request:1-0-0', SearchSponsorsRequestV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:search-sponsors-request', SearchSponsorsRequestV1);
