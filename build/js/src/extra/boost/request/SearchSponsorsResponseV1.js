...
export default class SearchSponsorsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:search-sponsors-response:1-0-0', SearchSponsorsResponseV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:search-sponsors-response', SearchSponsorsResponseV1);
