...
export default class GetSponsorHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:get-sponsor-history-response:1-0-0', GetSponsorHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:get-sponsor-history-response', GetSponsorHistoryResponseV1);
