...
export default class GetSponsorResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:get-sponsor-response:1-0-0', GetSponsorResponseV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:get-sponsor-response', GetSponsorResponseV1);
