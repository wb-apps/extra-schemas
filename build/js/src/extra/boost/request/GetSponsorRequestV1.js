...
export default class GetSponsorRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:request:get-sponsor-request:1-0-0', GetSponsorRequestV1,
      [],
      [
...
MessageResolver.register('extra:boost:request:get-sponsor-request', GetSponsorRequestV1);
