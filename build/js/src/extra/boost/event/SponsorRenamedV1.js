...
export default class SponsorRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-renamed:1-0-0', SponsorRenamedV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-renamed', SponsorRenamedV1);
