...
export default class SponsorDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-deleted:1-0-0', SponsorDeletedV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-deleted', SponsorDeletedV1);
