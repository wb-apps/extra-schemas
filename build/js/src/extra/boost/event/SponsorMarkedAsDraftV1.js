...
export default class SponsorMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-marked-as-draft:1-0-0', SponsorMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-marked-as-draft', SponsorMarkedAsDraftV1);
