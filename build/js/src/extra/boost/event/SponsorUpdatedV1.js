...
export default class SponsorUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-updated:1-0-0', SponsorUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-updated', SponsorUpdatedV1);
