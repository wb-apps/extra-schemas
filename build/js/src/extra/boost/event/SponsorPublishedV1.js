...
export default class SponsorPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-published:1-0-0', SponsorPublishedV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-published', SponsorPublishedV1);
