...
export default class SponsorUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-unpublished:1-0-0', SponsorUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-unpublished', SponsorUnpublishedV1);
