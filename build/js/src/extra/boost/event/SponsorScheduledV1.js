...
export default class SponsorScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-scheduled:1-0-0', SponsorScheduledV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-scheduled', SponsorScheduledV1);
