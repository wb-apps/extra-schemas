...
export default class SponsorExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:event:sponsor-expired:1-0-0', SponsorExpiredV1,
      [],
      [
...
MessageResolver.register('extra:boost:event:sponsor-expired', SponsorExpiredV1);
