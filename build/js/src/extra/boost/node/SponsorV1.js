// @link https://schemas.extratv.com/json-schema/extra/boost/node/sponsor/1-0-0.json#
...
export default class SponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:boost:node:sponsor:1-0-0', SponsorV1,
      [],
      [
...
MessageResolver.register('extra:boost:node:sponsor', SponsorV1);
