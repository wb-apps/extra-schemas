...
export default class CategoryRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:category-renamed:1-0-0', CategoryRenamedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:category-renamed', CategoryRenamedV1);
