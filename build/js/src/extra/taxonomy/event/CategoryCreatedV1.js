...
export default class CategoryCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:category-created:1-0-0', CategoryCreatedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:category-created', CategoryCreatedV1);
