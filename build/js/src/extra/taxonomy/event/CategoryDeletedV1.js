...
export default class CategoryDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:category-deleted:1-0-0', CategoryDeletedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:category-deleted', CategoryDeletedV1);
