...
export default class ChannelRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:channel-renamed:1-0-0', ChannelRenamedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:channel-renamed', ChannelRenamedV1);
