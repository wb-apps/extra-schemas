...
export default class ChannelDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:channel-deleted:1-0-0', ChannelDeletedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:channel-deleted', ChannelDeletedV1);
