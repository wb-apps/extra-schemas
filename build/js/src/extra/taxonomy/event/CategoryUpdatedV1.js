...
export default class CategoryUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:category-updated:1-0-0', CategoryUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:category-updated', CategoryUpdatedV1);
