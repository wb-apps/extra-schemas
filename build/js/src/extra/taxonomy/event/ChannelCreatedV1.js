...
export default class ChannelCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:channel-created:1-0-0', ChannelCreatedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:channel-created', ChannelCreatedV1);
