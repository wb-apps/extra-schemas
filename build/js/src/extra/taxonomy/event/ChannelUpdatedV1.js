...
export default class ChannelUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:event:channel-updated:1-0-0', ChannelUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:event:channel-updated', ChannelUpdatedV1);
