...
export default class RenameChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:rename-channel:1-0-0', RenameChannelV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:rename-channel', RenameChannelV1);
