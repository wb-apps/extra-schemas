...
export default class CreateCategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:create-category:1-0-0', CreateCategoryV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:create-category', CreateCategoryV1);
