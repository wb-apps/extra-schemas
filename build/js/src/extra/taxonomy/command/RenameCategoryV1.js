...
export default class RenameCategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:rename-category:1-0-0', RenameCategoryV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:rename-category', RenameCategoryV1);
