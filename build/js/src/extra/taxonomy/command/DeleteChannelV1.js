...
export default class DeleteChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:delete-channel:1-0-0', DeleteChannelV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:delete-channel', DeleteChannelV1);
