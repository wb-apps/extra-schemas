...
export default class UpdateChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:update-channel:1-0-0', UpdateChannelV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:update-channel', UpdateChannelV1);
