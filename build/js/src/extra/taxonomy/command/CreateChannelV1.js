...
export default class CreateChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:create-channel:1-0-0', CreateChannelV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:create-channel', CreateChannelV1);
