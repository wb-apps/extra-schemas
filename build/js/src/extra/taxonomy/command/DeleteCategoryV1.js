...
export default class DeleteCategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:delete-category:1-0-0', DeleteCategoryV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:delete-category', DeleteCategoryV1);
