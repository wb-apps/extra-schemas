...
export default class UpdateCategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:command:update-category:1-0-0', UpdateCategoryV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:command:update-category', UpdateCategoryV1);
