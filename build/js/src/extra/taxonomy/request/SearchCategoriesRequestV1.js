...
export default class SearchCategoriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:search-categories-request:1-0-0', SearchCategoriesRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:search-categories-request', SearchCategoriesRequestV1);
