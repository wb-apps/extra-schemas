// @link https://schemas.extra.com/json-schema/extra/taxonomy/request/suggest-hashtags-response/1-0-0.json#
...
export default class SuggestHashtagsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:suggest-hashtags-response:1-0-0', SuggestHashtagsResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:suggest-hashtags-response', SuggestHashtagsResponseV1);
