...
export default class SuggestHashtagsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:suggest-hashtags-request:1-0-0', SuggestHashtagsRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:suggest-hashtags-request', SuggestHashtagsRequestV1);
