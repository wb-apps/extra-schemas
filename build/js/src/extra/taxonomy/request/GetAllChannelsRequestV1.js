...
export default class GetAllChannelsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-all-channels-request:1-0-0', GetAllChannelsRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-all-channels-request', GetAllChannelsRequestV1);
