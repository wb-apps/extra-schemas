...
export default class SearchCategoriesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:search-categories-response:1-0-0', SearchCategoriesResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:search-categories-response', SearchCategoriesResponseV1);
