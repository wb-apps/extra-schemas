...
export default class GetCategoryHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-category-history-request:1-0-0', GetCategoryHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-category-history-request', GetCategoryHistoryRequestV1);
