...
export default class GetCategoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-category-response:1-0-0', GetCategoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-category-response', GetCategoryResponseV1);
