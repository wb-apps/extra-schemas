...
export default class GetChannelRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-channel-request:1-0-0', GetChannelRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-channel-request', GetChannelRequestV1);
