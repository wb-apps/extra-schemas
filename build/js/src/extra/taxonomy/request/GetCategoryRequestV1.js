...
export default class GetCategoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-category-request:1-0-0', GetCategoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-category-request', GetCategoryRequestV1);
