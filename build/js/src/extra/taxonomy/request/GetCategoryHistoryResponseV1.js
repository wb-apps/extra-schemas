...
export default class GetCategoryHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-category-history-response:1-0-0', GetCategoryHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-category-history-response', GetCategoryHistoryResponseV1);
