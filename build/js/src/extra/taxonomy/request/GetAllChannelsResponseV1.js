...
export default class GetAllChannelsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-all-channels-response:1-0-0', GetAllChannelsResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-all-channels-response', GetAllChannelsResponseV1);
