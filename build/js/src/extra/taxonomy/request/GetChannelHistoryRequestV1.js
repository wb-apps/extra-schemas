...
export default class GetChannelHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-channel-history-request:1-0-0', GetChannelHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-channel-history-request', GetChannelHistoryRequestV1);
