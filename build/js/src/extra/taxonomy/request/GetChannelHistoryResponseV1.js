...
export default class GetChannelHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:request:get-channel-history-response:1-0-0', GetChannelHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:request:get-channel-history-response', GetChannelHistoryResponseV1);
