// @link https://schemas.extratv.com/json-schema/extra/taxonomy/node/category/1-0-0.json#
...
export default class CategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:node:category:1-0-0', CategoryV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:node:category', CategoryV1);
