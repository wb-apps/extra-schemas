// @link https://schemas.extratv.com/json-schema/extra/taxonomy/node/channel/1-0-0.json#
...
export default class ChannelV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:taxonomy:node:channel:1-0-0', ChannelV1,
      [],
      [
...
MessageResolver.register('extra:taxonomy:node:channel', ChannelV1);
