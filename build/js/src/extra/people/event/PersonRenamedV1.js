...
export default class PersonRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:event:person-renamed:1-0-0', PersonRenamedV1,
      [],
      [
...
MessageResolver.register('extra:people:event:person-renamed', PersonRenamedV1);
