...
export default class PersonDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:event:person-deleted:1-0-0', PersonDeletedV1,
      [],
      [
...
MessageResolver.register('extra:people:event:person-deleted', PersonDeletedV1);
