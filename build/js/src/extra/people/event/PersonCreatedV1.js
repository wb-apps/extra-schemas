...
export default class PersonCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:event:person-created:1-0-0', PersonCreatedV1,
      [],
      [
...
MessageResolver.register('extra:people:event:person-created', PersonCreatedV1);
