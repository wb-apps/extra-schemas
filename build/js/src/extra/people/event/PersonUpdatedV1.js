...
export default class PersonUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:event:person-updated:1-0-0', PersonUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:people:event:person-updated', PersonUpdatedV1);
