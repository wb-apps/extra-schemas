...
export default class SearchPeopleResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:request:search-people-response:1-0-0', SearchPeopleResponseV1,
      [],
      [
...
MessageResolver.register('extra:people:request:search-people-response', SearchPeopleResponseV1);
