...
export default class GetPersonRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:request:get-person-request:1-0-0', GetPersonRequestV1,
      [],
      [
...
MessageResolver.register('extra:people:request:get-person-request', GetPersonRequestV1);
