...
export default class SearchPeopleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:request:search-people-request:1-0-0', SearchPeopleRequestV1,
      [],
      [
...
MessageResolver.register('extra:people:request:search-people-request', SearchPeopleRequestV1);
