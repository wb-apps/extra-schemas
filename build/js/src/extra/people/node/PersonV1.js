// @link https://schemas.extratv.com/json-schema/extra/people/node/person/1-0-0.json#
...
export default class PersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:node:person:1-0-0', PersonV1,
      [],
      [
...
MessageResolver.register('extra:people:node:person', PersonV1);
