...
export default class UpdatePersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:command:update-person:1-0-0', UpdatePersonV1,
      [],
      [
...
MessageResolver.register('extra:people:command:update-person', UpdatePersonV1);
