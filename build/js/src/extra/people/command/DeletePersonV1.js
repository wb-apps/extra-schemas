...
export default class DeletePersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:command:delete-person:1-0-0', DeletePersonV1,
      [],
      [
...
MessageResolver.register('extra:people:command:delete-person', DeletePersonV1);
