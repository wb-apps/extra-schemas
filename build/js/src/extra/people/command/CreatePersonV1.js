...
export default class CreatePersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:command:create-person:1-0-0', CreatePersonV1,
      [],
      [
...
MessageResolver.register('extra:people:command:create-person', CreatePersonV1);
