...
export default class RenamePersonV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:people:command:rename-person:1-0-0', RenamePersonV1,
      [],
      [
...
MessageResolver.register('extra:people:command:rename-person', RenamePersonV1);
