...
export default class GetUploadUrlsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-upload-urls-response:1-0-0', GetUploadUrlsResponseV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-upload-urls-response', GetUploadUrlsResponseV1);
