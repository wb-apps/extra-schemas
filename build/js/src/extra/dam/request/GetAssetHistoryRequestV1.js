...
export default class GetAssetHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-asset-history-request:1-0-0', GetAssetHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-asset-history-request', GetAssetHistoryRequestV1);
