...
export default class GetAssetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-asset-response:1-0-0', GetAssetResponseV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-asset-response', GetAssetResponseV1);
