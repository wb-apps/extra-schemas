...
export default class GetUploadUrlsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-upload-urls-request:1-0-0', GetUploadUrlsRequestV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-upload-urls-request', GetUploadUrlsRequestV1);
