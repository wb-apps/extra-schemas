...
export default class SearchAssetsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:search-assets-request:1-0-0', SearchAssetsRequestV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:search-assets-request', SearchAssetsRequestV1);
