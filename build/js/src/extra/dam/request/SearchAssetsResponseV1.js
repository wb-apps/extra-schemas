...
export default class SearchAssetsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:search-assets-response:1-0-0', SearchAssetsResponseV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:search-assets-response', SearchAssetsResponseV1);
