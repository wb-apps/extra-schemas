...
export default class GetAssetHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-asset-history-response:1-0-0', GetAssetHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-asset-history-response', GetAssetHistoryResponseV1);
