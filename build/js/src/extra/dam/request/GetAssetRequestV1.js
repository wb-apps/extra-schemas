...
export default class GetAssetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:request:get-asset-request:1-0-0', GetAssetRequestV1,
      [],
      [
...
MessageResolver.register('extra:dam:request:get-asset-request', GetAssetRequestV1);
