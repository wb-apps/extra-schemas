...
export default class GalleryAssetReorderedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:dam:event:gallery-asset-reordered:1-0-0', GalleryAssetReorderedV1,
      [],
      [
...
MessageResolver.register('extra:dam:event:gallery-asset-reordered', GalleryAssetReorderedV1);
