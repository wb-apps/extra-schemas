// @link https://schemas.extra.com/json-schema/extra/notify/request/get-notification-history-response/1-0-0.json#
...
export default class GetNotificationHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:request:get-notification-history-response:1-0-0', GetNotificationHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:notify:request:get-notification-history-response', GetNotificationHistoryResponseV1);
