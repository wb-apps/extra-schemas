...
export default class GetNotificationRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:request:get-notification-request:1-0-0', GetNotificationRequestV1,
      [],
      [
...
MessageResolver.register('extra:notify:request:get-notification-request', GetNotificationRequestV1);
