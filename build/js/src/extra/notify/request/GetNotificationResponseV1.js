...
export default class GetNotificationResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:request:get-notification-response:1-0-0', GetNotificationResponseV1,
      [],
      [
...
MessageResolver.register('extra:notify:request:get-notification-response', GetNotificationResponseV1);
