...
export default class SearchNotificationsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:request:search-notifications-request:1-0-0', SearchNotificationsRequestV1,
      [],
      [
...
MessageResolver.register('extra:notify:request:search-notifications-request', SearchNotificationsRequestV1);
