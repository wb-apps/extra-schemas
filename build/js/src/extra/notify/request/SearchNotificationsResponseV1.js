...
export default class SearchNotificationsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:request:search-notifications-response:1-0-0', SearchNotificationsResponseV1,
      [],
      [
...
MessageResolver.register('extra:notify:request:search-notifications-response', SearchNotificationsResponseV1);
