...
export default class NotificationSentV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:event:notification-sent:1-0-0', NotificationSentV1,
      [],
      [
...
MessageResolver.register('extra:notify:event:notification-sent', NotificationSentV1);
