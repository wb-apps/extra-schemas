...
export default class NotificationUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:event:notification-updated:1-0-0', NotificationUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:notify:event:notification-updated', NotificationUpdatedV1);
