...
export default class NotificationFailedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:event:notification-failed:1-0-0', NotificationFailedV1,
      [],
      [
...
MessageResolver.register('extra:notify:event:notification-failed', NotificationFailedV1);
