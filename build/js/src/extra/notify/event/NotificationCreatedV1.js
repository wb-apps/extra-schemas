...
export default class NotificationCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:event:notification-created:1-0-0', NotificationCreatedV1,
      [],
      [
...
MessageResolver.register('extra:notify:event:notification-created', NotificationCreatedV1);
