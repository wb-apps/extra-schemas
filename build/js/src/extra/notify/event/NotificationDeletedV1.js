...
export default class NotificationDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:event:notification-deleted:1-0-0', NotificationDeletedV1,
      [],
      [
...
MessageResolver.register('extra:notify:event:notification-deleted', NotificationDeletedV1);
