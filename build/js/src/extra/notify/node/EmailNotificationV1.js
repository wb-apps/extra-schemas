// @link https://schemas.extratv.com/json-schema/extra/notify/node/email-notification/1-0-0.json#
...
export default class EmailNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:email-notification:1-0-0', EmailNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:email-notification', EmailNotificationV1);
