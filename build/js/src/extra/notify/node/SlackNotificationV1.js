// @link https://schemas.extratv.com/json-schema/extra/notify/node/slack-notification/1-0-0.json#
...
export default class SlackNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:slack-notification:1-0-0', SlackNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:slack-notification', SlackNotificationV1);
