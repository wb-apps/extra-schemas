// @link https://schemas.extratv.com/json-schema/extra/notify/node/twitter-notification/1-0-0.json#
...
export default class TwitterNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:twitter-notification:1-0-0', TwitterNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:twitter-notification', TwitterNotificationV1);
