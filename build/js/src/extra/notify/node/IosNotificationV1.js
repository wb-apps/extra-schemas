// @link https://schemas.extratv.com/json-schema/extra/notify/node/ios-notification/1-0-0.json#
...
export default class IosNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:ios-notification:1-0-0', IosNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:ios-notification', IosNotificationV1);
