// @link https://schemas.extra.com/json-schema/extra/notify/node/alexa-notification/1-0-0.json#
...
export default class AlexaNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:alexa-notification:1-0-0', AlexaNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:alexa-notification', AlexaNotificationV1);
