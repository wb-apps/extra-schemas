// @link https://schemas.extratv.com/json-schema/extra/notify/node/browser-notification/1-0-0.json#
...
export default class BrowserNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:browser-notification:1-0-0', BrowserNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:browser-notification', BrowserNotificationV1);
