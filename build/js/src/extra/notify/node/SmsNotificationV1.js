// @link https://schemas.extratv.com/json-schema/extra/notify/node/sms-notification/1-0-0.json#
...
export default class SmsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:node:sms-notification:1-0-0', SmsNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:node:sms-notification', SmsNotificationV1);
