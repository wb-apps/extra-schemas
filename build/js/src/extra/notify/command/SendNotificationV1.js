...
export default class SendNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:command:send-notification:1-0-0', SendNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:command:send-notification', SendNotificationV1);
