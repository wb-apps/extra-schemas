...
export default class DeleteNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:command:delete-notification:1-0-0', DeleteNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:command:delete-notification', DeleteNotificationV1);
