...
export default class CreateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:command:create-notification:1-0-0', CreateNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:command:create-notification', CreateNotificationV1);
