...
export default class UpdateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:notify:command:update-notification:1-0-0', UpdateNotificationV1,
      [],
      [
...
MessageResolver.register('extra:notify:command:update-notification', UpdateNotificationV1);
