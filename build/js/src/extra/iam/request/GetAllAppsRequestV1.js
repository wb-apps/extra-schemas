...
export default class GetAllAppsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-all-apps-request:1-0-0', GetAllAppsRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-all-apps-request', GetAllAppsRequestV1);
