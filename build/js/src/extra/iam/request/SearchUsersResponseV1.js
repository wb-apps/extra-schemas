...
export default class SearchUsersResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:search-users-response:1-0-0', SearchUsersResponseV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:search-users-response', SearchUsersResponseV1);
