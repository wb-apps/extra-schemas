...
export default class GetRoleHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-role-history-request:1-0-0', GetRoleHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-role-history-request', GetRoleHistoryRequestV1);
