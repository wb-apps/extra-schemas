...
export default class GetAppHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-app-history-request:1-0-0', GetAppHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-app-history-request', GetAppHistoryRequestV1);
