...
export default class GetUserRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-user-request:1-0-0', GetUserRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-user-request', GetUserRequestV1);
