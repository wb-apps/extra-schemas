...
export default class SearchUsersRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:search-users-request:1-0-0', SearchUsersRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:search-users-request', SearchUsersRequestV1);
