...
export default class ListAllRolesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:list-all-roles-request:1-0-0', ListAllRolesRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:list-all-roles-request', ListAllRolesRequestV1);
