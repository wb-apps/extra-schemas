...
export default class GetRoleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-role-request:1-0-0', GetRoleRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-role-request', GetRoleRequestV1);
