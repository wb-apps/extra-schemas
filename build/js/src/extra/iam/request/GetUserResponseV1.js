...
export default class GetUserResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-user-response:1-0-0', GetUserResponseV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-user-response', GetUserResponseV1);
