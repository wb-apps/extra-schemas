...
export default class GetAppRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-app-request:1-0-0', GetAppRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-app-request', GetAppRequestV1);
