...
export default class ListAllRolesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:list-all-roles-response:1-0-0', ListAllRolesResponseV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:list-all-roles-response', ListAllRolesResponseV1);
