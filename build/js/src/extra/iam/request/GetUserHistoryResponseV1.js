...
export default class GetUserHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-user-history-response:1-0-0', GetUserHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-user-history-response', GetUserHistoryResponseV1);
