...
export default class GetUserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:request:get-user-history-request:1-0-0', GetUserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:iam:request:get-user-history-request', GetUserHistoryRequestV1);
