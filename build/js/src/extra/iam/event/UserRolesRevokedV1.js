...
export default class UserRolesRevokedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:event:user-roles-revoked:1-0-0', UserRolesRevokedV1,
      [],
      [
...
MessageResolver.register('extra:iam:event:user-roles-revoked', UserRolesRevokedV1);
