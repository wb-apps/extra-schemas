...
export default class AppRolesGrantedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:event:app-roles-granted:1-0-0', AppRolesGrantedV1,
      [],
      [
...
MessageResolver.register('extra:iam:event:app-roles-granted', AppRolesGrantedV1);
