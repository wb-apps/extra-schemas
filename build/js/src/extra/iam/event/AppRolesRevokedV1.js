...
export default class AppRolesRevokedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:event:app-roles-revoked:1-0-0', AppRolesRevokedV1,
      [],
      [
...
MessageResolver.register('extra:iam:event:app-roles-revoked', AppRolesRevokedV1);
