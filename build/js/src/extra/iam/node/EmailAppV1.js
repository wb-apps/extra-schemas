// @link https://schemas.extratv.com/json-schema/extra/iam/node/email-app/1-0-0.json#
...
export default class EmailAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:node:email-app:1-0-0', EmailAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:node:email-app', EmailAppV1);
