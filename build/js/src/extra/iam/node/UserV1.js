...
const M = UserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:node:user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:node:user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:node:user:v1';
