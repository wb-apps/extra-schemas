// @link https://schemas.extratv.com/json-schema/extra/iam/node/browser-app/1-0-0.json#
...
export default class BrowserAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:node:browser-app:1-0-0', BrowserAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:node:browser-app', BrowserAppV1);
