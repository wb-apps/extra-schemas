// @link https://schemas.extratv.com/json-schema/extra/iam/node/slack-app/1-0-0.json#
...
export default class SlackAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:node:slack-app:1-0-0', SlackAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:node:slack-app', SlackAppV1);
