// @link https://schemas.extra.com/json-schema/extra/iam/command/create-user/1-0-0.json#
...
export default class CreateUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:command:create-user:1-0-0', CreateUserV1,
      [],
      [
...
MessageResolver.register('extra:iam:command:create-user', CreateUserV1);
