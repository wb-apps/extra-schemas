// @link https://schemas.extratv.com/json-schema/extra/iam/command/update-app/1-0-0.json#
...
const M = UpdateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:command:update-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:command:update-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:command:update-app:v1';
