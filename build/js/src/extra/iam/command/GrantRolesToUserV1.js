// @link https://schemas.extratv.com/json-schema/extra/iam/command/grant-roles-to-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:iam:command:grant-roles-to-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:iam:command:grant-roles-to-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:iam:command:grant-roles-to-user:v1';
