...
export default class GrantRolesToUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:command:grant-roles-to-user:1-0-0', GrantRolesToUserV1,
      [],
      [
...
MessageResolver.register('extra:iam:command:grant-roles-to-user', GrantRolesToUserV1);
