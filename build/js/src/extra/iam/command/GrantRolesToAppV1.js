...
export default class GrantRolesToAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:command:grant-roles-to-app:1-0-0', GrantRolesToAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:command:grant-roles-to-app', GrantRolesToAppV1);
