...
export default class RevokeRolesFromAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:command:revoke-roles-from-app:1-0-0', RevokeRolesFromAppV1,
      [],
      [
...
MessageResolver.register('extra:iam:command:revoke-roles-from-app', RevokeRolesFromAppV1);
