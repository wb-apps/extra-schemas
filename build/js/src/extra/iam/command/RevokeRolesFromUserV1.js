...
export default class RevokeRolesFromUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:iam:command:revoke-roles-from-user:1-0-0', RevokeRolesFromUserV1,
      [],
      [
...
MessageResolver.register('extra:iam:command:revoke-roles-from-user', RevokeRolesFromUserV1);
