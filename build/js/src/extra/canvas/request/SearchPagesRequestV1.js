...
export default class SearchPagesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:search-pages-request:1-0-0', SearchPagesRequestV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:search-pages-request', SearchPagesRequestV1);
