...
export default class SearchPagesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:search-pages-response:1-0-0', SearchPagesResponseV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:search-pages-response', SearchPagesResponseV1);
