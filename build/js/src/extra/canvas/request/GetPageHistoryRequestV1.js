...
export default class GetPageHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:get-page-history-request:1-0-0', GetPageHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:get-page-history-request', GetPageHistoryRequestV1);
