...
export default class GetPageRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:get-page-request:1-0-0', GetPageRequestV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:get-page-request', GetPageRequestV1);
