...
export default class GetPageHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:get-page-history-response:1-0-0', GetPageHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:get-page-history-response', GetPageHistoryResponseV1);
