...
export default class GetPageResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:request:get-page-response:1-0-0', GetPageResponseV1,
      [],
      [
...
MessageResolver.register('extra:canvas:request:get-page-response', GetPageResponseV1);
