...
export default class FacebookVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:facebook-video-block:1-0-0', FacebookVideoBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:facebook-video-block', FacebookVideoBlockV1);
