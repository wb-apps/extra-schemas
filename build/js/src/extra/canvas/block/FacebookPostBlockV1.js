...
export default class FacebookPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:facebook-post-block:1-0-0', FacebookPostBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:facebook-post-block', FacebookPostBlockV1);
