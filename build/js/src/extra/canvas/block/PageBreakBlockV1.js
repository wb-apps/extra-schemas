...
export default class PageBreakBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:page-break-block:1-0-0', PageBreakBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:page-break-block', PageBreakBlockV1);
