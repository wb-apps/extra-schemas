...
export default class TwitterTweetBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:twitter-tweet-block:1-0-0', TwitterTweetBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:twitter-tweet-block', TwitterTweetBlockV1);
