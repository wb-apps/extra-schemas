...
export default class YoutubePlaylistBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:youtube-playlist-block:1-0-0', YoutubePlaylistBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:youtube-playlist-block', YoutubePlaylistBlockV1);
