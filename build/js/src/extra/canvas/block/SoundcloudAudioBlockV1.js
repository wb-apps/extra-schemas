...
export default class SoundcloudAudioBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:soundcloud-audio-block:1-0-0', SoundcloudAudioBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:soundcloud-audio-block', SoundcloudAudioBlockV1);
