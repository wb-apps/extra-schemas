...
export default class PinterestPinBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:pinterest-pin-block:1-0-0', PinterestPinBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:pinterest-pin-block', PinterestPinBlockV1);
