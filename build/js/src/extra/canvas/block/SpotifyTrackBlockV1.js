// @link https://schemas.extra.com/json-schema/extra/canvas/block/spotify-track-block/1-0-0.json#
...
export default class SpotifyTrackBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:spotify-track-block:1-0-0', SpotifyTrackBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:spotify-track-block', SpotifyTrackBlockV1);
