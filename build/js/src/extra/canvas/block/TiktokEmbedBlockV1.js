...
export default class TiktokEmbedBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:tiktok-embed-block:1-0-0', TiktokEmbedBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:tiktok-embed-block', TiktokEmbedBlockV1);
