...
export default class DocumentBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:document-block:1-0-0', DocumentBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:document-block', DocumentBlockV1);
