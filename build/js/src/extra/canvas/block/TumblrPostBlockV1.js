...
export default class TumblrPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:tumblr-post-block:1-0-0', TumblrPostBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:tumblr-post-block', TumblrPostBlockV1);
