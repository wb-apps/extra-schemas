...
export default class GoogleMapBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:google-map-block:1-0-0', GoogleMapBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:google-map-block', GoogleMapBlockV1);
