...
export default class ImgurPostBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:imgur-post-block:1-0-0', ImgurPostBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:imgur-post-block', ImgurPostBlockV1);
