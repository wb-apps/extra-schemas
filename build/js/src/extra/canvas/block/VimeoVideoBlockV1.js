...
export default class VimeoVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:vimeo-video-block:1-0-0', VimeoVideoBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:vimeo-video-block', VimeoVideoBlockV1);
