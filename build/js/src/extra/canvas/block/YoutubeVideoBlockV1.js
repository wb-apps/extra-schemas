...
export default class YoutubeVideoBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:youtube-video-block:1-0-0', YoutubeVideoBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:youtube-video-block', YoutubeVideoBlockV1);
