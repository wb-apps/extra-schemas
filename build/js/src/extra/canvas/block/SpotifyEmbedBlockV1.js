...
export default class SpotifyEmbedBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:spotify-embed-block:1-0-0', SpotifyEmbedBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:spotify-embed-block', SpotifyEmbedBlockV1);
