...
export default class InstagramMediaBlockV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:block:instagram-media-block:1-0-0', InstagramMediaBlockV1,
      [],
      [
...
MessageResolver.register('extra:canvas:block:instagram-media-block', InstagramMediaBlockV1);
