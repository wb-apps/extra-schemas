...
export default class PageMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:event:page-marked-as-draft:1-0-0', PageMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:canvas:event:page-marked-as-draft', PageMarkedAsDraftV1);
