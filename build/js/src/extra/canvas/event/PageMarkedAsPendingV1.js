...
export default class PageMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:event:page-marked-as-pending:1-0-0', PageMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:canvas:event:page-marked-as-pending', PageMarkedAsPendingV1);
