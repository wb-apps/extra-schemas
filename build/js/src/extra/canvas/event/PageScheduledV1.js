...
export default class PageScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:event:page-scheduled:1-0-0', PageScheduledV1,
      [],
      [
...
MessageResolver.register('extra:canvas:event:page-scheduled', PageScheduledV1);
