...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('extra:canvas:event:page-published', PagePublishedV1);
