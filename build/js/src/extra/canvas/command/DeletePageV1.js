// @link https://schemas.extratv.com/json-schema/extra/canvas/command/delete-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:canvas:command:delete-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:canvas:command:delete-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:canvas:command:delete-page:v1';
