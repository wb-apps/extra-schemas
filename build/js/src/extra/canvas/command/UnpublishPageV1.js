...
export default class UnpublishPageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:command:unpublish-page:1-0-0', UnpublishPageV1,
      [],
      [
...
MessageResolver.register('extra:canvas:command:unpublish-page', UnpublishPageV1);
