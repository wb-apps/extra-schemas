...
export default class MarkPageAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:command:mark-page-as-draft:1-0-0', MarkPageAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:canvas:command:mark-page-as-draft', MarkPageAsDraftV1);
