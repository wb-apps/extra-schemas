...
export default class MarkPageAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:command:mark-page-as-pending:1-0-0', MarkPageAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:canvas:command:mark-page-as-pending', MarkPageAsPendingV1);
