// @link https://schemas.extratv.com/json-schema/extra/canvas/node/page/1-0-0.json#
...
export default class PageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:canvas:node:page:1-0-0', PageV1,
      [],
      [
...
MessageResolver.register('extra:canvas:node:page', PageV1);
