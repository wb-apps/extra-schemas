...
export default class GetVideoResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:request:get-video-response:1-0-0', GetVideoResponseV1,
      [],
      [
...
MessageResolver.register('extra:ovp:request:get-video-response', GetVideoResponseV1);
