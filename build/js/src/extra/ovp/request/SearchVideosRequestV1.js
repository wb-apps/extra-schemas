...
export default class SearchVideosRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:request:search-videos-request:1-0-0', SearchVideosRequestV1,
      [],
      [
...
MessageResolver.register('extra:ovp:request:search-videos-request', SearchVideosRequestV1);
