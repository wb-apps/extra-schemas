...
export default class SearchVideosResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:request:search-videos-response:1-0-0', SearchVideosResponseV1,
      [],
      [
...
MessageResolver.register('extra:ovp:request:search-videos-response', SearchVideosResponseV1);
