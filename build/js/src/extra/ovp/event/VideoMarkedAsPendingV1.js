...
export default class VideoMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:event:video-marked-as-pending:1-0-0', VideoMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:ovp:event:video-marked-as-pending', VideoMarkedAsPendingV1);
