...
export default class VideoMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:event:video-marked-as-draft:1-0-0', VideoMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:ovp:event:video-marked-as-draft', VideoMarkedAsDraftV1);
