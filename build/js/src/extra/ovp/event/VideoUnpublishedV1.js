...
export default class VideoUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:event:video-unpublished:1-0-0', VideoUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:ovp:event:video-unpublished', VideoUnpublishedV1);
