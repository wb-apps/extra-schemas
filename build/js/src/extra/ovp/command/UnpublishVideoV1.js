...
export default class UnpublishVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:command:unpublish-video:1-0-0', UnpublishVideoV1,
      [],
      [
...
MessageResolver.register('extra:ovp:command:unpublish-video', UnpublishVideoV1);
