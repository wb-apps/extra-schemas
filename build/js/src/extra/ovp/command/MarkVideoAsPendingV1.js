...
export default class MarkVideoAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:ovp:command:mark-video-as-pending:1-0-0', MarkVideoAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:ovp:command:mark-video-as-pending', MarkVideoAsPendingV1);
