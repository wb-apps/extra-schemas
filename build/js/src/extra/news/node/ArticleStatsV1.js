// @link https://schemas.extratv.com/json-schema/extra/news/node/article-stats/1-0-0.json#
...
export default class ArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:node:article-stats:1-0-0', ArticleStatsV1,
      [],
      [
...
MessageResolver.register('extra:news:node:article-stats', ArticleStatsV1);
