...
export default class ArticleStatsCollectedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-stats-collected:1-0-0', ArticleStatsCollectedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-stats-collected', ArticleStatsCollectedV1);
