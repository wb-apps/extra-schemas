...
export default class ArticleUnlockedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-unlocked:1-0-0', ArticleUnlockedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-unlocked', ArticleUnlockedV1);
