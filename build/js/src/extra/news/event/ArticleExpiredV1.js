...
export default class ArticleExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-expired:1-0-0', ArticleExpiredV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-expired', ArticleExpiredV1);
