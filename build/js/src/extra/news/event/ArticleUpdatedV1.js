...
export default class ArticleUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-updated:1-0-0', ArticleUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-updated', ArticleUpdatedV1);
