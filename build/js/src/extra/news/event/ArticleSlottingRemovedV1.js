...
export default class ArticleSlottingRemovedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-slotting-removed:1-0-0', ArticleSlottingRemovedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-slotting-removed', ArticleSlottingRemovedV1);
