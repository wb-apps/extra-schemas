...
export default class ArticleScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-scheduled:1-0-0', ArticleScheduledV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-scheduled', ArticleScheduledV1);
