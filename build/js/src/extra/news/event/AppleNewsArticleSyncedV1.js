...
export default class AppleNewsArticleSyncedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:apple-news-article-synced:1-0-0', AppleNewsArticleSyncedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:apple-news-article-synced', AppleNewsArticleSyncedV1);
