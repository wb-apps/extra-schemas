...
export default class ArticleMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-marked-as-draft:1-0-0', ArticleMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-marked-as-draft', ArticleMarkedAsDraftV1);
