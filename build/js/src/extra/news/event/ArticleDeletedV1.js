...
export default class ArticleDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-deleted:1-0-0', ArticleDeletedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-deleted', ArticleDeletedV1);
