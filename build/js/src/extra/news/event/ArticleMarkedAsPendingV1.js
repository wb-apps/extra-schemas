...
export default class ArticleMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-marked-as-pending:1-0-0', ArticleMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-marked-as-pending', ArticleMarkedAsPendingV1);
