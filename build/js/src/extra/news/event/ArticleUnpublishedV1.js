...
export default class ArticleUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-unpublished:1-0-0', ArticleUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-unpublished', ArticleUnpublishedV1);
