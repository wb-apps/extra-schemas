...
export default class ArticleCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-created:1-0-0', ArticleCreatedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-created', ArticleCreatedV1);
