...
export default class ArticlePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:event:article-published:1-0-0', ArticlePublishedV1,
      [],
      [
...
MessageResolver.register('extra:news:event:article-published', ArticlePublishedV1);
