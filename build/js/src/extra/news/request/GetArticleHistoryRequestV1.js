...
export default class GetArticleHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:get-article-history-request:1-0-0', GetArticleHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:news:request:get-article-history-request', GetArticleHistoryRequestV1);
