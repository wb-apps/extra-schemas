...
export default class GetArticleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:get-article-request:1-0-0', GetArticleRequestV1,
      [],
      [
...
MessageResolver.register('extra:news:request:get-article-request', GetArticleRequestV1);
