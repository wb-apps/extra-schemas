...
export default class SearchArticlesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:search-articles-request:1-0-0', SearchArticlesRequestV1,
      [],
      [
...
MessageResolver.register('extra:news:request:search-articles-request', SearchArticlesRequestV1);
