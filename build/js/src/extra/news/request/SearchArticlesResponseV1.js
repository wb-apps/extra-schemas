...
export default class SearchArticlesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:search-articles-response:1-0-0', SearchArticlesResponseV1,
      [],
      [
...
MessageResolver.register('extra:news:request:search-articles-response', SearchArticlesResponseV1);
