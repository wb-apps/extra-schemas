...
export default class GetArticleResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:get-article-response:1-0-0', GetArticleResponseV1,
      [],
      [
...
MessageResolver.register('extra:news:request:get-article-response', GetArticleResponseV1);
