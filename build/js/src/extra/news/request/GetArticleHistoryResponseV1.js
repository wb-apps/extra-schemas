...
export default class GetArticleHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:request:get-article-history-response:1-0-0', GetArticleHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:news:request:get-article-history-response', GetArticleHistoryResponseV1);
