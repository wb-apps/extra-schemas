...
export default class ExpireArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:expire-article:1-0-0', ExpireArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:expire-article', ExpireArticleV1);
