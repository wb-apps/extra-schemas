...
export default class RenameArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:rename-article:1-0-0', RenameArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:rename-article', RenameArticleV1);
