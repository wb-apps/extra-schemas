...
export default class DeleteArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:delete-article:1-0-0', DeleteArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:delete-article', DeleteArticleV1);
