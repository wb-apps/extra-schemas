...
export default class UpdateArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:update-article:1-0-0', UpdateArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:update-article', UpdateArticleV1);
