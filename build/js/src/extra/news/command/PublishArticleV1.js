...
export default class PublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:publish-article:1-0-0', PublishArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:publish-article', PublishArticleV1);
