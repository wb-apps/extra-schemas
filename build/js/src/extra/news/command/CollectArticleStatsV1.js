...
export default class CollectArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:collect-article-stats:1-0-0', CollectArticleStatsV1,
      [],
      [
...
MessageResolver.register('extra:news:command:collect-article-stats', CollectArticleStatsV1);
