...
export default class RemoveArticleSlottingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:remove-article-slotting:1-0-0', RemoveArticleSlottingV1,
      [],
      [
...
MessageResolver.register('extra:news:command:remove-article-slotting', RemoveArticleSlottingV1);
