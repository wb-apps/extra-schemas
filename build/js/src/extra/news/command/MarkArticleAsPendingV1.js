...
export default class MarkArticleAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:mark-article-as-pending:1-0-0', MarkArticleAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:news:command:mark-article-as-pending', MarkArticleAsPendingV1);
