...
export default class UnpublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:unpublish-article:1-0-0', UnpublishArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:unpublish-article', UnpublishArticleV1);
