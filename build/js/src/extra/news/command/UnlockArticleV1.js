...
export default class UnlockArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:unlock-article:1-0-0', UnlockArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:unlock-article', UnlockArticleV1);
