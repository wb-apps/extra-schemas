...
export default class CreateArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:create-article:1-0-0', CreateArticleV1,
      [],
      [
...
MessageResolver.register('extra:news:command:create-article', CreateArticleV1);
