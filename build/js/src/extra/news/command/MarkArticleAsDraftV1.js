...
export default class MarkArticleAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:news:command:mark-article-as-draft:1-0-0', MarkArticleAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:news:command:mark-article-as-draft', MarkArticleAsDraftV1);
