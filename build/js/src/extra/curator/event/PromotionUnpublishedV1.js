...
export default class PromotionUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-unpublished:1-0-0', PromotionUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-unpublished', PromotionUnpublishedV1);
