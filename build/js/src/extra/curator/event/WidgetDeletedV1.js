...
export default class WidgetDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:widget-deleted:1-0-0', WidgetDeletedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:widget-deleted', WidgetDeletedV1);
