...
export default class GalleryCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-created:1-0-0', GalleryCreatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-created', GalleryCreatedV1);
