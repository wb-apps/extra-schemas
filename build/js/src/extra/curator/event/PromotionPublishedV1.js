...
export default class PromotionPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-published:1-0-0', PromotionPublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-published', PromotionPublishedV1);
