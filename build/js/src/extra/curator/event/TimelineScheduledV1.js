...
export default class TimelineScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-scheduled:1-0-0', TimelineScheduledV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-scheduled', TimelineScheduledV1);
