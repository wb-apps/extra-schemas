...
export default class PromotionDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-deleted:1-0-0', PromotionDeletedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-deleted', PromotionDeletedV1);
