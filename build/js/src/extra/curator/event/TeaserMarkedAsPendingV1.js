...
export default class TeaserMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-marked-as-pending:1-0-0', TeaserMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-marked-as-pending', TeaserMarkedAsPendingV1);
