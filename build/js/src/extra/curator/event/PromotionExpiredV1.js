...
export default class PromotionExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-expired:1-0-0', PromotionExpiredV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-expired', PromotionExpiredV1);
