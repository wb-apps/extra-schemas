...
export default class TimelineDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-deleted:1-0-0', TimelineDeletedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-deleted', TimelineDeletedV1);
