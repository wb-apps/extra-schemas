...
export default class PromotionMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-marked-as-draft:1-0-0', PromotionMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-marked-as-draft', PromotionMarkedAsDraftV1);
