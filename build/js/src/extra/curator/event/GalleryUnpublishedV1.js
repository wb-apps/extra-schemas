...
export default class GalleryUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-unpublished:1-0-0', GalleryUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-unpublished', GalleryUnpublishedV1);
