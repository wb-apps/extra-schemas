...
export default class TimelineUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-unpublished:1-0-0', TimelineUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-unpublished', TimelineUnpublishedV1);
