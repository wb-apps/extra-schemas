...
export default class WidgetUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:widget-updated:1-0-0', WidgetUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:widget-updated', WidgetUpdatedV1);
