...
export default class TeaserPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-published:1-0-0', TeaserPublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-published', TeaserPublishedV1);
