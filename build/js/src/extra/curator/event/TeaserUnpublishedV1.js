...
export default class TeaserUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-unpublished:1-0-0', TeaserUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-unpublished', TeaserUnpublishedV1);
