...
export default class GalleryMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-marked-as-draft:1-0-0', GalleryMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-marked-as-draft', GalleryMarkedAsDraftV1);
