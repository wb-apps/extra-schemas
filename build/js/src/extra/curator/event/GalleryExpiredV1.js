...
export default class GalleryExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-expired:1-0-0', GalleryExpiredV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-expired', GalleryExpiredV1);
