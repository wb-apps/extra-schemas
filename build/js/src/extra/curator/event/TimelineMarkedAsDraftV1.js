// @link https://schemas.extra.com/json-schema/extra/curator/event/timeline-marked-as-draft/1-0-0.json#
...
export default class TimelineMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-marked-as-draft:1-0-0', TimelineMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-marked-as-draft', TimelineMarkedAsDraftV1);
