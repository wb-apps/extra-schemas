...
export default class PromotionUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-updated:1-0-0', PromotionUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-updated', PromotionUpdatedV1);
