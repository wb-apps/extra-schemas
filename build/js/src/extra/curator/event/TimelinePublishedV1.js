...
export default class TimelinePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-published:1-0-0', TimelinePublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-published', TimelinePublishedV1);
