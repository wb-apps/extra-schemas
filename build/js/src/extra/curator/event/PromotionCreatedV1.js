...
export default class PromotionCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-created:1-0-0', PromotionCreatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-created', PromotionCreatedV1);
