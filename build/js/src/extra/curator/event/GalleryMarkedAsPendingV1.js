...
export default class GalleryMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-marked-as-pending:1-0-0', GalleryMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-marked-as-pending', GalleryMarkedAsPendingV1);
