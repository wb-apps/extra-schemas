...
export default class TeaserExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-expired:1-0-0', TeaserExpiredV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-expired', TeaserExpiredV1);
