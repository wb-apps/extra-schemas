...
export default class TeaserSlottingRemovedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-slotting-removed:1-0-0', TeaserSlottingRemovedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-slotting-removed', TeaserSlottingRemovedV1);
