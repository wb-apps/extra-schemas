...
export default class GalleryPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-published:1-0-0', GalleryPublishedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-published', GalleryPublishedV1);
