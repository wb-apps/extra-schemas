...
export default class TimelineUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-updated:1-0-0', TimelineUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-updated', TimelineUpdatedV1);
