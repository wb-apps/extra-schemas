...
export default class PromotionScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-scheduled:1-0-0', PromotionScheduledV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-scheduled', PromotionScheduledV1);
