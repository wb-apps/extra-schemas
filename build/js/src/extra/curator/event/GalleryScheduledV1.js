...
export default class GalleryScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-scheduled:1-0-0', GalleryScheduledV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-scheduled', GalleryScheduledV1);
