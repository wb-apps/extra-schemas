...
export default class PromotionMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:promotion-marked-as-pending:1-0-0', PromotionMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:promotion-marked-as-pending', PromotionMarkedAsPendingV1);
