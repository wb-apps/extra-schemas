...
export default class GalleryImageCountUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:gallery-image-count-updated:1-0-0', GalleryImageCountUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:gallery-image-count-updated', GalleryImageCountUpdatedV1);
