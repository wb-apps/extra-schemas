...
export default class TimelineRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-renamed:1-0-0', TimelineRenamedV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-renamed', TimelineRenamedV1);
