...
export default class TimelineMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:timeline-marked-as-pending:1-0-0', TimelineMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:timeline-marked-as-pending', TimelineMarkedAsPendingV1);
