...
export default class TeaserScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-scheduled:1-0-0', TeaserScheduledV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-scheduled', TeaserScheduledV1);
