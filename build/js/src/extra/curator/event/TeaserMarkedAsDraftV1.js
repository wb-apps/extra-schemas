...
export default class TeaserMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:event:teaser-marked-as-draft:1-0-0', TeaserMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:event:teaser-marked-as-draft', TeaserMarkedAsDraftV1);
