// @link https://schemas.extratv.com/json-schema/extra/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:channel-teaser', ChannelTeaserV1);
