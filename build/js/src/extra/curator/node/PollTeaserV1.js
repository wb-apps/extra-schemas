// @link https://schemas.extratv.com/json-schema/extra/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:poll-teaser', PollTeaserV1);
