// @link https://schemas.extratv.com/json-schema/extra/curator/node/code-widget/1-0-0.json#
...
export default class CodeWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:code-widget:1-0-0', CodeWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:code-widget', CodeWidgetV1);
