// @link https://schemas.extratv.com/json-schema/extra/curator/node/media-list-widget/1-0-0.json#
...
export default class MediaListWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:media-list-widget:1-0-0', MediaListWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:media-list-widget', MediaListWidgetV1);
