// @link https://schemas.extratv.com/json-schema/extra/curator/node/slider-widget/1-0-0.json#
...
export default class SliderWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:slider-widget:1-0-0', SliderWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:slider-widget', SliderWidgetV1);
