// @link https://schemas.extratv.com/json-schema/extra/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:category-teaser', CategoryTeaserV1);
