// @link https://schemas.extratv.com/json-schema/extra/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:spotlight-widget', SpotlightWidgetV1);
