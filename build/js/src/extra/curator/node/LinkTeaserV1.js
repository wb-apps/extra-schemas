// @link https://schemas.extratv.com/json-schema/extra/curator/node/link-teaser/1-0-0.json#
...
export default class LinkTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:link-teaser:1-0-0', LinkTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:link-teaser', LinkTeaserV1);
