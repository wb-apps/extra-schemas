// @link https://schemas.extratv.com/json-schema/extra/curator/node/timeline-teaser/1-0-0.json#
...
export default class TimelineTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:timeline-teaser:1-0-0', TimelineTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:timeline-teaser', TimelineTeaserV1);
