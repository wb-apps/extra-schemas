// @link https://schemas.extratv.com/json-schema/extra/curator/node/asset-teaser/1-0-0.json#
...
export default class AssetTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:asset-teaser', AssetTeaserV1);
