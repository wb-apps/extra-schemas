// @link https://schemas.extratv.com/json-schema/extra/curator/node/playlist-widget/1-0-0.json#
...
export default class PlaylistWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:playlist-widget:1-0-0', PlaylistWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:playlist-widget', PlaylistWidgetV1);
