// @link https://schemas.extratv.com/json-schema/extra/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:article-teaser', ArticleTeaserV1);
