// @link https://schemas.extratv.com/json-schema/extra/curator/node/timeline/1-0-1.json#
...
export default class TimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:timeline:1-0-1', TimelineV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:timeline', TimelineV1);
