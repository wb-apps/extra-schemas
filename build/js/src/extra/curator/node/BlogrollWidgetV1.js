// @link https://schemas.extratv.com/json-schema/extra/curator/node/blogroll-widget/1-0-0.json#
...
export default class BlogrollWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:blogroll-widget:1-0-0', BlogrollWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:blogroll-widget', BlogrollWidgetV1);
