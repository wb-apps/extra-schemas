// @link https://schemas.extratv.com/json-schema/extra/curator/node/promotion/1-0-0.json#
...
export default class PromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:promotion:1-0-0', PromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:promotion', PromotionV1);
