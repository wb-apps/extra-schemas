// @link https://schemas.extratv.com/json-schema/extra/curator/node/showtimes-widget/1-0-0.json#
...
export default class ShowtimesWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:showtimes-widget:1-0-0', ShowtimesWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:showtimes-widget', ShowtimesWidgetV1);
