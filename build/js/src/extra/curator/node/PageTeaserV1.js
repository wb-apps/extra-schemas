// @link https://schemas.extratv.com/json-schema/extra/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:page-teaser', PageTeaserV1);
