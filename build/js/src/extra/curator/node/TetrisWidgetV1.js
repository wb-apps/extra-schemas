// @link https://schemas.extratv.com/json-schema/extra/curator/node/tetris-widget/1-0-0.json#
...
export default class TetrisWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:tetris-widget:1-0-0', TetrisWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:tetris-widget', TetrisWidgetV1);
