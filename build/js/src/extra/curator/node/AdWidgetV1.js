// @link https://schemas.extratv.com/json-schema/extra/curator/node/ad-widget/1-0-0.json#
...
export default class AdWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:ad-widget:1-0-0', AdWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:ad-widget', AdWidgetV1);
