// @link https://schemas.extratv.com/json-schema/extra/curator/node/gridler-widget/1-0-0.json#
...
export default class GridlerWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:gridler-widget:1-0-0', GridlerWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:gridler-widget', GridlerWidgetV1);
