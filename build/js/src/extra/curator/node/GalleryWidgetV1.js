// @link https://schemas.extratv.com/json-schema/extra/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:gallery-widget', GalleryWidgetV1);
