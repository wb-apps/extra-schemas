// @link https://schemas.extratv.com/json-schema/extra/curator/node/person-teaser/1-0-0.json#
...
export default class PersonTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:person-teaser', PersonTeaserV1);
