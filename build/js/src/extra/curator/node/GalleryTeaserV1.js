// @link https://schemas.extratv.com/json-schema/extra/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:gallery-teaser', GalleryTeaserV1);
