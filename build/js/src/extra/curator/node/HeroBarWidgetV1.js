// @link https://schemas.extratv.com/json-schema/extra/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:node:hero-bar-widget', HeroBarWidgetV1);
