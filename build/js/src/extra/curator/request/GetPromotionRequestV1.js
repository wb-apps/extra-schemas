...
export default class GetPromotionRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-promotion-request:1-0-0', GetPromotionRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-promotion-request', GetPromotionRequestV1);
