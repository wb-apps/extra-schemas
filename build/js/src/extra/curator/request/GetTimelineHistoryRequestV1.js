...
export default class GetTimelineHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-timeline-history-request:1-0-0', GetTimelineHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-timeline-history-request', GetTimelineHistoryRequestV1);
