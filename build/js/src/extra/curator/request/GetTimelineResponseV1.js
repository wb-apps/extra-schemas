...
export default class GetTimelineResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-timeline-response:1-0-0', GetTimelineResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-timeline-response', GetTimelineResponseV1);
