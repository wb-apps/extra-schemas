...
export default class SearchTeasersResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-teasers-response:1-0-0', SearchTeasersResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-teasers-response', SearchTeasersResponseV1);
