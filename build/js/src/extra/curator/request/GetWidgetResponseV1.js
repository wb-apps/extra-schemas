...
export default class GetWidgetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-widget-response:1-0-0', GetWidgetResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-widget-response', GetWidgetResponseV1);
