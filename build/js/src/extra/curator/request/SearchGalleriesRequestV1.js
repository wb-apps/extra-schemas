...
export default class SearchGalleriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-galleries-request:1-0-0', SearchGalleriesRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-galleries-request', SearchGalleriesRequestV1);
