...
export default class GetWidgetHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-widget-history-request:1-0-0', GetWidgetHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-widget-history-request', GetWidgetHistoryRequestV1);
