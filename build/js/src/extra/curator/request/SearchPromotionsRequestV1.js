...
export default class SearchPromotionsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-promotions-request:1-0-0', SearchPromotionsRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-promotions-request', SearchPromotionsRequestV1);
