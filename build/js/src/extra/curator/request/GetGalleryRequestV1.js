...
export default class GetGalleryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-gallery-request:1-0-0', GetGalleryRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-gallery-request', GetGalleryRequestV1);
