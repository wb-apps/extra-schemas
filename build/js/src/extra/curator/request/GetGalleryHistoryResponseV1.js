...
export default class GetGalleryHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-gallery-history-response:1-0-0', GetGalleryHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-gallery-history-response', GetGalleryHistoryResponseV1);
