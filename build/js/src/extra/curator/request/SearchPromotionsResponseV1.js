...
export default class SearchPromotionsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-promotions-response:1-0-0', SearchPromotionsResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-promotions-response', SearchPromotionsResponseV1);
