...
export default class SearchWidgetsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-widgets-response:1-0-0', SearchWidgetsResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-widgets-response', SearchWidgetsResponseV1);
