...
export default class GetTeaserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-teaser-history-request:1-0-0', GetTeaserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-teaser-history-request', GetTeaserHistoryRequestV1);
