...
export default class GetTeaserResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-teaser-response:1-0-0', GetTeaserResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-teaser-response', GetTeaserResponseV1);
