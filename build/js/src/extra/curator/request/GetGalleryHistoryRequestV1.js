...
export default class GetGalleryHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-gallery-history-request:1-0-0', GetGalleryHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-gallery-history-request', GetGalleryHistoryRequestV1);
