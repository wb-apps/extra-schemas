...
export default class GetWidgetHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-widget-history-response:1-0-0', GetWidgetHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-widget-history-response', GetWidgetHistoryResponseV1);
