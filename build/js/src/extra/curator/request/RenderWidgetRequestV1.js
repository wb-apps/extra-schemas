...
export default class RenderWidgetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:render-widget-request:1-0-0', RenderWidgetRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:render-widget-request', RenderWidgetRequestV1);
