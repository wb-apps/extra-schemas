...
export default class SearchTimelinesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-timelines-request:1-0-0', SearchTimelinesRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-timelines-request', SearchTimelinesRequestV1);
