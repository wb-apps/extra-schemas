...
export default class GetTeaserRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-teaser-request:1-0-0', GetTeaserRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-teaser-request', GetTeaserRequestV1);
