...
export default class GetTeaserHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-teaser-history-response:1-0-0', GetTeaserHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-teaser-history-response', GetTeaserHistoryResponseV1);
