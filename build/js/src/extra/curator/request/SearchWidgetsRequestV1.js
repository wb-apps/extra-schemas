...
export default class SearchWidgetsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-widgets-request:1-0-0', SearchWidgetsRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-widgets-request', SearchWidgetsRequestV1);
