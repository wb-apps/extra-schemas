...
export default class RenderWidgetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:render-widget-response:1-0-0', RenderWidgetResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:render-widget-response', RenderWidgetResponseV1);
