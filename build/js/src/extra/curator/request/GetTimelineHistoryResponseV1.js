...
export default class GetTimelineHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-timeline-history-response:1-0-0', GetTimelineHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-timeline-history-response', GetTimelineHistoryResponseV1);
