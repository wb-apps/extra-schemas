...
export default class SearchTeasersRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-teasers-request:1-0-0', SearchTeasersRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-teasers-request', SearchTeasersRequestV1);
