...
export default class SearchTimelinesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-timelines-response:1-0-0', SearchTimelinesResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-timelines-response', SearchTimelinesResponseV1);
