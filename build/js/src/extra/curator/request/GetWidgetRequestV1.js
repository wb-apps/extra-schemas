...
export default class GetWidgetRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:get-widget-request:1-0-0', GetWidgetRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:get-widget-request', GetWidgetRequestV1);
