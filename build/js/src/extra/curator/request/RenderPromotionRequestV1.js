...
export default class RenderPromotionRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:render-promotion-request:1-0-0', RenderPromotionRequestV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:render-promotion-request', RenderPromotionRequestV1);
