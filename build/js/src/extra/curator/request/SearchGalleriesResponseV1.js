...
export default class SearchGalleriesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:request:search-galleries-response:1-0-0', SearchGalleriesResponseV1,
      [],
      [
...
MessageResolver.register('extra:curator:request:search-galleries-response', SearchGalleriesResponseV1);
