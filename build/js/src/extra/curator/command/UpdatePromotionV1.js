...
export default class UpdatePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:update-promotion:1-0-0', UpdatePromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:update-promotion', UpdatePromotionV1);
