...
export default class UnpublishPromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:unpublish-promotion:1-0-0', UnpublishPromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:unpublish-promotion', UnpublishPromotionV1);
