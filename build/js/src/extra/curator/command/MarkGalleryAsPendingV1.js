...
export default class MarkGalleryAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:mark-gallery-as-pending:1-0-0', MarkGalleryAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:mark-gallery-as-pending', MarkGalleryAsPendingV1);
