...
export default class DeleteWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:delete-widget:1-0-0', DeleteWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:delete-widget', DeleteWidgetV1);
