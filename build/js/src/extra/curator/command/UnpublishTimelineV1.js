...
export default class UnpublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:unpublish-timeline:1-0-0', UnpublishTimelineV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:unpublish-timeline', UnpublishTimelineV1);
