...
export default class DeletePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:delete-promotion:1-0-0', DeletePromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:delete-promotion', DeletePromotionV1);
