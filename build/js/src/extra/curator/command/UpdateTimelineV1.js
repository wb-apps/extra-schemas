...
export default class UpdateTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:update-timeline:1-0-0', UpdateTimelineV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:update-timeline', UpdateTimelineV1);
