...
export default class DeleteGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:delete-gallery:1-0-0', DeleteGalleryV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:delete-gallery', DeleteGalleryV1);
