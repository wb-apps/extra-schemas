...
export default class UnpublishGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:unpublish-gallery:1-0-0', UnpublishGalleryV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:unpublish-gallery', UnpublishGalleryV1);
