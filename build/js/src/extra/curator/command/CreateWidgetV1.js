...
export default class CreateWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:create-widget:1-0-0', CreateWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:create-widget', CreateWidgetV1);
