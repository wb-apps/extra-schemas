...
export default class UpdateWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:update-widget:1-0-0', UpdateWidgetV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:update-widget', UpdateWidgetV1);
