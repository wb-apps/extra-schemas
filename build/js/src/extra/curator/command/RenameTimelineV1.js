...
export default class RenameTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:rename-timeline:1-0-0', RenameTimelineV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:rename-timeline', RenameTimelineV1);
