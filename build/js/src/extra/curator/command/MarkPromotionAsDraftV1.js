...
export default class MarkPromotionAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:mark-promotion-as-draft:1-0-0', MarkPromotionAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:mark-promotion-as-draft', MarkPromotionAsDraftV1);
