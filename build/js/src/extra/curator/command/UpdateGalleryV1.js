...
export default class UpdateGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:update-gallery:1-0-0', UpdateGalleryV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:update-gallery', UpdateGalleryV1);
