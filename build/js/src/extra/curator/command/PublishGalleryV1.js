...
export default class PublishGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:publish-gallery:1-0-0', PublishGalleryV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:publish-gallery', PublishGalleryV1);
