...
export default class ExpirePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:expire-promotion:1-0-0', ExpirePromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:expire-promotion', ExpirePromotionV1);
