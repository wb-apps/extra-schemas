...
export default class RemoveTeaserSlottingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:remove-teaser-slotting:1-0-0', RemoveTeaserSlottingV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:remove-teaser-slotting', RemoveTeaserSlottingV1);
