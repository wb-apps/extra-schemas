...
export default class UpdateGalleryImageCountV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:update-gallery-image-count:1-0-0', UpdateGalleryImageCountV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:update-gallery-image-count', UpdateGalleryImageCountV1);
