...
export default class MarkTeaserAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:mark-teaser-as-pending:1-0-0', MarkTeaserAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:mark-teaser-as-pending', MarkTeaserAsPendingV1);
