...
export default class ExpireGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:expire-gallery:1-0-0', ExpireGalleryV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:expire-gallery', ExpireGalleryV1);
