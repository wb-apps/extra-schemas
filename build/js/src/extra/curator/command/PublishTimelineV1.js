...
export default class PublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:publish-timeline:1-0-0', PublishTimelineV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:publish-timeline', PublishTimelineV1);
