...
export default class MarkTimelineAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:mark-timeline-as-draft:1-0-0', MarkTimelineAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:mark-timeline-as-draft', MarkTimelineAsDraftV1);
