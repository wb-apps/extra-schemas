...
export default class PublishPromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:publish-promotion:1-0-0', PublishPromotionV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:publish-promotion', PublishPromotionV1);
