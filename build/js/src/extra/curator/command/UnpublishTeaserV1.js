...
export default class UnpublishTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:curator:command:unpublish-teaser:1-0-0', UnpublishTeaserV1,
      [],
      [
...
MessageResolver.register('extra:curator:command:unpublish-teaser', UnpublishTeaserV1);
