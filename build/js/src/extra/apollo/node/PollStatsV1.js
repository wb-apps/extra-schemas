// @link https://schemas.extratv.com/json-schema/extra/apollo/node/poll-stats/1-0-0.json#
...
export default class PollStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:node:poll-stats:1-0-0', PollStatsV1,
      [],
      [
...
MessageResolver.register('extra:apollo:node:poll-stats', PollStatsV1);
