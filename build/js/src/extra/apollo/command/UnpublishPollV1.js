...
export default class UnpublishPollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:command:unpublish-poll:1-0-0', UnpublishPollV1,
      [],
      [
...
MessageResolver.register('extra:apollo:command:unpublish-poll', UnpublishPollV1);
