...
export default class SearchPollsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:search-polls-request:1-0-0', SearchPollsRequestV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:search-polls-request', SearchPollsRequestV1);
