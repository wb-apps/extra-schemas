...
export default class GetPollHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:get-poll-history-response:1-0-0', GetPollHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:get-poll-history-response', GetPollHistoryResponseV1);
