...
export default class SearchPollsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:search-polls-response:1-0-0', SearchPollsResponseV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:search-polls-response', SearchPollsResponseV1);
