...
export default class GetPollResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:get-poll-response:1-0-0', GetPollResponseV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:get-poll-response', GetPollResponseV1);
