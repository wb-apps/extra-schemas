...
export default class GetPollRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:get-poll-request:1-0-0', GetPollRequestV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:get-poll-request', GetPollRequestV1);
