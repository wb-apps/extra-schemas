...
export default class GetPollHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:request:get-poll-history-request:1-0-0', GetPollHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:apollo:request:get-poll-history-request', GetPollHistoryRequestV1);
