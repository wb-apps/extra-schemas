// @link https://schemas.extra.com/json-schema/extra/apollo/poll-answer/1-0-0.json#
...
export default class PollAnswerV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo::poll-answer:1-0-0', PollAnswerV1,
      [],
      [
...
MessageResolver.register('extra:apollo::poll-answer', PollAnswerV1);
