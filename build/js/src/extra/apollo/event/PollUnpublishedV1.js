...
export default class PollUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:event:poll-unpublished:1-0-0', PollUnpublishedV1,
      [],
      [
...
MessageResolver.register('extra:apollo:event:poll-unpublished', PollUnpublishedV1);
