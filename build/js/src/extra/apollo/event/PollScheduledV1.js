...
export default class PollScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:event:poll-scheduled:1-0-0', PollScheduledV1,
      [],
      [
...
MessageResolver.register('extra:apollo:event:poll-scheduled', PollScheduledV1);
