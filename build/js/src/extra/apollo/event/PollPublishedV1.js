...
export default class PollPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:event:poll-published:1-0-0', PollPublishedV1,
      [],
      [
...
MessageResolver.register('extra:apollo:event:poll-published', PollPublishedV1);
