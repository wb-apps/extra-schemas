// @link https://schemas.extra.com/json-schema/extra/apollo/event/poll-marked-as-draft/1-0-0.json#
...
export default class PollMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:event:poll-marked-as-draft:1-0-0', PollMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('extra:apollo:event:poll-marked-as-draft', PollMarkedAsDraftV1);
