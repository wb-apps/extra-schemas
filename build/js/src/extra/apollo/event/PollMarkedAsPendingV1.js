...
export default class PollMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:apollo:event:poll-marked-as-pending:1-0-0', PollMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('extra:apollo:event:poll-marked-as-pending', PollMarkedAsPendingV1);
