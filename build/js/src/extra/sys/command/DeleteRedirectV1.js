...
export default class DeleteRedirectV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:delete-redirect:1-0-0', DeleteRedirectV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:delete-redirect', DeleteRedirectV1);
