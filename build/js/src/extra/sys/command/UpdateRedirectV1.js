...
export default class UpdateRedirectV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:update-redirect:1-0-0', UpdateRedirectV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:update-redirect', UpdateRedirectV1);
