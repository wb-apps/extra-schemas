...
export default class CreatePicklistV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:create-picklist:1-0-0', CreatePicklistV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:create-picklist', CreatePicklistV1);
