...
export default class UpdatePicklistV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:command:update-picklist:1-0-0', UpdatePicklistV1,
      [],
      [
...
MessageResolver.register('extra:sys:command:update-picklist', UpdatePicklistV1);
