...
export default class GetFlagsetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-flagset-response:1-0-0', GetFlagsetResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-flagset-response', GetFlagsetResponseV1);
