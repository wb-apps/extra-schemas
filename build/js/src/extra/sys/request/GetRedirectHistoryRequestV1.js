...
export default class GetRedirectHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-redirect-history-request:1-0-0', GetRedirectHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-redirect-history-request', GetRedirectHistoryRequestV1);
