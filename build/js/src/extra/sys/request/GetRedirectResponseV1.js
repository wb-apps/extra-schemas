...
export default class GetRedirectResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-redirect-response:1-0-0', GetRedirectResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-redirect-response', GetRedirectResponseV1);
