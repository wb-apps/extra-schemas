...
export default class ListAllFlagsetsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:list-all-flagsets-request:1-0-0', ListAllFlagsetsRequestV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:list-all-flagsets-request', ListAllFlagsetsRequestV1);
