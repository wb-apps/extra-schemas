...
export default class SearchRedirectsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:search-redirects-response:1-0-0', SearchRedirectsResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:search-redirects-response', SearchRedirectsResponseV1);
