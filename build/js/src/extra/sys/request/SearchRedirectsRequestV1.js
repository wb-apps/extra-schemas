...
export default class SearchRedirectsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:search-redirects-request:1-0-0', SearchRedirectsRequestV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:search-redirects-request', SearchRedirectsRequestV1);
