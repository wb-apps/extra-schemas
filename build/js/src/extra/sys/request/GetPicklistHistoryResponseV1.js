...
export default class GetPicklistHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-picklist-history-response:1-0-0', GetPicklistHistoryResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-picklist-history-response', GetPicklistHistoryResponseV1);
