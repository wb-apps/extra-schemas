...
export default class ListAllFlagsetsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:list-all-flagsets-response:1-0-0', ListAllFlagsetsResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:list-all-flagsets-response', ListAllFlagsetsResponseV1);
