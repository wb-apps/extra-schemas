...
export default class ListAllPicklistsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:list-all-picklists-request:1-0-0', ListAllPicklistsRequestV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:list-all-picklists-request', ListAllPicklistsRequestV1);
