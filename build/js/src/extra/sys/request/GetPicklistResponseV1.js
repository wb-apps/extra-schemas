...
export default class GetPicklistResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-picklist-response:1-0-0', GetPicklistResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-picklist-response', GetPicklistResponseV1);
