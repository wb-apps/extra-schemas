...
export default class GetPicklistHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:get-picklist-history-request:1-0-0', GetPicklistHistoryRequestV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:get-picklist-history-request', GetPicklistHistoryRequestV1);
