...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:extra:sys:request:list-all-picklists-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'extra:sys:request:list-all-picklists-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'extra:sys:request:list-all-picklists-response:v1';
