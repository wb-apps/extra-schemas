...
export default class ListAllPicklistsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:request:list-all-picklists-response:1-0-0', ListAllPicklistsResponseV1,
      [],
      [
...
MessageResolver.register('extra:sys:request:list-all-picklists-response', ListAllPicklistsResponseV1);
