...
export default class RedirectDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:event:redirect-deleted:1-0-0', RedirectDeletedV1,
      [],
      [
...
MessageResolver.register('extra:sys:event:redirect-deleted', RedirectDeletedV1);
