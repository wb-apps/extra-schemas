...
export default class RedirectCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:event:redirect-created:1-0-0', RedirectCreatedV1,
      [],
      [
...
MessageResolver.register('extra:sys:event:redirect-created', RedirectCreatedV1);
