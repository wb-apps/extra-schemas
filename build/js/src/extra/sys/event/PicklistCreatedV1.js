...
export default class PicklistCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:event:picklist-created:1-0-0', PicklistCreatedV1,
      [],
      [
...
MessageResolver.register('extra:sys:event:picklist-created', PicklistCreatedV1);
