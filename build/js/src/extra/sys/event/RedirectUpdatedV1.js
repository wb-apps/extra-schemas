...
export default class RedirectUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:extra:sys:event:redirect-updated:1-0-0', RedirectUpdatedV1,
      [],
      [
...
MessageResolver.register('extra:sys:event:redirect-updated', RedirectUpdatedV1);
